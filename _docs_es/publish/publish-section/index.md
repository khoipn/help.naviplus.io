...
> Después de elegir **Reemplazar**, considera agregar CSS para ocultar el elemento original mientras Navi+ carga — ver [Publish Optimize](/docs/publish/publish-optimize/).
