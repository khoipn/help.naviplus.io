...
| # | Tema | |
|---|---|---|
| 1 | Descripción general de tipos de menú y métodos de implementación | [Publish Overview](/docs/publish/publish-overview/) |
| 2 | Sticky / FAB — App Embeds (Shopify) o `<head>` (Global) | [Publish Sticky](/docs/publish/publish-sticky/) |
| 3 | Menú Slide — activación basada en disparador | [Publish Slide](/docs/publish/publish-slide/) |
| 4 | Section / Mega / Grid — Insertar/Reemplazar y App Block | [Publish Section](/docs/publish/publish-section/) |
| 5 | Filtrar por dispositivo y palabra clave de URL | [Publish Filter](/docs/publish/publish-filter/) |
| 6 | Optimizar velocidad y UX tras la publicación | [Publish Optimize](/docs/publish/publish-optimize/) |
