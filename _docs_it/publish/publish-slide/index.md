...
> Dopo aver configurato un trigger CSS Selector, considera di nascondere l'elemento originale per evitare il flash — vedi [Publish Optimize](/docs/publish/publish-optimize/).
