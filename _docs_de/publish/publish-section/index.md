...
> Nach Wahl von **Ersetzen** sollte CSS hinzugefügt werden, um das ursprüngliche Element während des Ladens von Navi+ auszublenden — siehe [Publish Optimize](/docs/publish/publish-optimize/).
