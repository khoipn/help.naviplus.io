...
| # | Thema | |
|---|---|---|
| 1 | Animation, Erweiterungseffekte und Touch-Feedback | [Einstellung Verhalten](/docs/setting/setting-behavior/) |
| 2 | Position, Abstände, Z-Index und Untermenübreite | [Einstellung Layout](/docs/setting/setting-layout/) |
| 3 | Anzeigen/Ausblenden nach URL, Gerät und Shopify-Seitentyp | [Einstellung Anzeigeregeln](/docs/setting/setting-display-rules/) |
| 4 | Slide-Richtung, Breite und Schließen-Schaltfläche | [Einstellung Slide](/docs/setting/setting-slide/) |
