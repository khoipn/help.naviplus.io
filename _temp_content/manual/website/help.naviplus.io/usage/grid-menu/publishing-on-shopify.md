...
<summary>How to insert this menu before the main of website<strong>?</strong></summary>
...
<summary>How to replace the default Grid Menu?</summary>
...
```
GET https://help.shopifas.com/manual/website/help.naviplus.io/usage/grid-menu/publishing-on-shopify.md?ask=<question>
```
