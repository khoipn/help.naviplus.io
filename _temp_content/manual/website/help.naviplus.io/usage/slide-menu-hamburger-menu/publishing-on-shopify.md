...
<summary>Purpose 1: Improved visibility and user experience by showing the full site map in the slide menu while keeping it easy to access.</summary>
...
<summary>Purpose 2: <strong>Unlimited menu depth with a large, flexible menu structure (Only Navi+)</strong></summary>
...
<summary>How to replace your website’s default hambuger menu with the Navi+ Slide Menu (<strong>Popular guide)?</strong></summary>
...
```
GET https://help.shopifas.com/manual/website/help.naviplus.io/usage/slide-menu-hamburger-menu/publishing-on-shopify.md?ask=<question>
```
