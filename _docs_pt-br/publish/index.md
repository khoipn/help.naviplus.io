...
| # | Tópico | |
|---|---|---|
| 1 | Visão geral dos tipos de menu e métodos de deploy | [Publish Overview](/docs/publish/publish-overview/) |
| 2 | Sticky / FAB — App Embeds (Shopify) ou `<head>` (Global) | [Publish Sticky](/docs/publish/publish-sticky/) |
| 3 | Menu Slide — ativação baseada em gatilho | [Publish Slide](/docs/publish/publish-slide/) |
| 4 | Section / Mega / Grid — Insert/Replace e App Block | [Publish Section](/docs/publish/publish-section/) |
| 5 | Filtrar por dispositivo e palavra-chave de URL | [Publish Filter](/docs/publish/publish-filter/) |
| 6 | Otimizar velocidade e UX após publicar | [Publish Optimize](/docs/publish/publish-optimize/) |
