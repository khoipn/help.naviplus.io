---
description: Il s'agit du problème de remplissage en bas sous la barre inférieure lorsqu'un site Web Shopify utilisant Navi+ est ouvert dans l'application Google sur iPhone.
lang: fr
layout: default
...
Il s'agit du problème de remplissage en bas sous la barre inférieure lorsqu'un site Web Shopify utilisant **Navi+** est ouvert dans l'application Google sur iPhone.
