...
lang: fr
layout: default
permalink: /fr/docs/usage/tabbar-bottom-navigation/publish-on-wordpress-woo-wix-others/
title: Publier sur Squarespace / Autres
---
# Publier sur Squarespace / Autres

> **Sur WordPress ?** Utilisez le [plugin Naviplus Menu Builder]({{ site.baseurl }}/docs/usage/tabbar-bottom-navigation/publish-on-wordpress/) au lieu de l'intégration manuelle ci-dessous — pas d'éditions de thème, pas de shortcode pour la Tab Bar.
