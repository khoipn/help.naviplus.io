---
description: Publiez une barre d'onglets Navi+ sur WordPress avec le plugin Navi+ — sans modifications de code. La barre d'onglets est un menu fixe, elle s'affiche automatiquement sur tout le site une fois publiée dans l'éditeur.
lang: fr
layout: default
...
La **Barre d'onglets** est un menu **fixe** — il s'ancre à la fenêtre d'affichage (généralement près du bas sur mobile) et reste en place pendant que les visiteurs font défiler. Sur WordPress, le plugin Navi+ rend la barre d'onglets automatiquement sur tout le site ; vous n'avez pas besoin de coller de code ou de shortcode.
