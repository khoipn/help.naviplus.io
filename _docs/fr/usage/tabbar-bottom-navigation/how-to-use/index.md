---
description: '**Tab Bar** - également connu sous le nom de Bottom Navigation Bar, Bottom Nav, ou Tab Navigation - est un style de navigation moderne utilisé par des marques mondiales comme Shein, ASOS, Zara, E...'
lang: fr
layout: default
permalink: /fr/docs/usage/tabbar-bottom-navigation/how-to-use/
title: Comment utiliser?
---
# Comment utiliser?

**Tab Bar** - également connu sous le nom de Bottom Navigation Bar, Bottom Nav, ou Tab Navigation - est un style de navigation moderne utilisé par des marques mondiales comme Shein, ASOS, Zara, Etsy, H\&M, Nike, et Uniqlo pour améliorer l'expérience utilisateur mobile. Il fonctionne bien pour des sites web de toutes tailles et est efficace à la fois sur mobile et sur desktop.

**Avantages clés :**

* Place des liens importants à portée de main pour un accès rapide et pratique
* Centralise la navigation clé, aidant les utilisateurs et les moteurs de recherche à mieux comprendre votre site – excellent pour le SEO
* Offre un look moderne et professionnel qui suit les tendances actuelles de l'UX et du design mobile-friendly
* Reste visible sur toutes les pages, donc les clients ne manquent jamais de liens clés comme les promotions, les produits tendance, ou les offres d'adhésion
...
Voici un exemple d'arbre de menu :
...
C'est un arbre de menu à 3 niveaux. Le niveau 1 comprend **Accueil**, **Catalogue**, **Support** et **Plus**.  
**Tout-Montagne** est un élément de menu de niveau 2, avec deux éléments enfants : **Cruise Flex** et **Balance Ride**.
...
<figure><img src="https://4226540503-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F4y2gLTmg4ToH5vkorG8s%2Fuploads%2FtQ9D4xrOCxqQxjj74WRw%2FHelp.MenuTree.1.1.2.png?alt=media&#x26;token=83384bd6-770d-483f-a3d6-86e9fd179c48" alt="
...
<figure><img src="https://4226540503-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F4y2gLTmg4ToH5vkorG8s%2Fuploads%2F7sc9FpChWOuKSxqLdxKc%2FHelp.MenuTree.1.1.3.png?alt=media&#x26;token=5bfe79ad-ee91-4556-b368-5fac17bab2f6" alt="
"><figcaption></figcaption></figure>
