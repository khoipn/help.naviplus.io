...
lang: fr
layout: default
permalink: /fr/docs/usage/shopify/optimize-loading-speed-slide-and-mega-menus/
title: Optimiser la vitesse de chargement (Slide & Mega menus)
---
# Optimiser la vitesse de chargement (Slide & Mega menus)
...
#### Slide Menu : Ajoutez un effet de chargement et verrouillez le sélecteur de déclenchement
...
#### Mega Menu (mode de remplacement) : Ajoutez un effet de chargement et verrouillez le sélecteur de déclenchement
