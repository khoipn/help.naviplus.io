...
#### **I) MÉTHODE 1 : INSÉRER (AVANT OU APRÈS) CE MENU À UN ENDROIT SPÉCIFIQUE DE VOTRE SITE WEB, OU REMPLACER UN MENU EXISTANT, EN UTILISANT UN SÉLECTEUR CSS. (**&#x52;ECOMMENDED)
...
#### I.2. Sélectionnez les paramètres d'affichage et publiez le menu.
...
Dans ce guide, nous nous concentrerons sur 1 façon : insérer ce menu avant le principal. Vous pouvez également utiliser cette méthode de manière créative en trouvant et en appliquant d'autres sélecteurs CSS pour déclencher le menu.

<details><summary>Comment insérer ce menu avant le principal du site web<strong>?</strong></summary>
