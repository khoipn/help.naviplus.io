...
<details><summary>Option 1 : Insérer Avant (le plus courant pour le Menu Grille)</summary>
...
<p><strong>Exemple :</strong> Sélecteur CSS <code>main</code> → le Menu Grille apparaît au-dessus de la zone de contenu principal de la page.</p>
...
<p><strong>Exemple :</strong> Sélecteur CSS <code>header</code> → le Menu Grille apparaît juste en dessous de l'en-tête.</p>
<p>Sélecteurs CSS courants pour les thèmes Shopify (Dawn, Sense, Savor, Horizon) :</p>
<ul>
...
<p>Sur la plupart des boutiques Shopify, il n'y a pas d'élément Menu Grille intégré à remplacer. Insérer Avant <code>main</code> est l'approche recommandée.</p>
