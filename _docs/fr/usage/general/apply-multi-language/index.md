...
Par exemple, imaginez que vous avez un Tabbar Navi+ affiché sur votre site Web avec 3 langues : anglais (par défaut), français et vietnamien. Le code court pour le français est `fr` et pour le vietnamien est `vi`.
...
Lorsque votre Tabbar est affiché, Navi+ vérifiera automatiquement la langue actuelle.
