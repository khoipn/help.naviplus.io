...
Pour afficher l'élément de menu **Accueil** dans la bonne langue, utilisez cette syntaxe :
...
* Si le défaut est l'anglais, il affiche **Home**.
...
2\) Créez un menu de changement de langue dans Navi+
...
* **Étape 1 :** (Optionnel) Ajoutez des icônes de drapeau si vous le souhaitez. Vous pouvez télécharger des icônes de drapeau sur des sites Web comme [Flaticon](https://www.flaticon.com "Flaticon") (Par exemple : <https://www.flaticon.com/authors/flags/rectangular?author_id=1&type=standard>).
