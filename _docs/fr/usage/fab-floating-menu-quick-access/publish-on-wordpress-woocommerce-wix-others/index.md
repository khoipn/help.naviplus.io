...
lang: fr
layout: default
permalink: /fr/docs/usage/fab-floating-menu-quick-access/publish-on-wordpress-woocommerce-wix-others/
title: Publier sur Squarespace / Autres
---
# Publier sur Squarespace / Autres

> **Sur WordPress ?** Utilisez le [plugin Naviplus Menu Builder]({{ site.baseurl }}/docs/usage/fab-floating-menu-quick-access/publish-on-wordpress/) dédié au lieu de l'intégration manuelle ci-dessous — pas d'éditions de thème, le FAB s'affiche sur tout le site automatiquement une fois publié dans l'éditeur.
