---
description: Publiez un Menu Glissant Navi+ (hamburger) sur WordPress avec le plugin Navi+. Le plugin charge le menu sur tout le site et le déclencheur est configuré dans l'éditeur Navi+ — pas d'éditions de thème, pas de shortcode pour la configuration typique.
lang: fr
layout: default
