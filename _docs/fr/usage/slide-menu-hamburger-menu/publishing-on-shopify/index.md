...
Cette méthode vous permet d'ouvrir un menu déroulant lorsque l'utilisateur clique ou touche un élément de menu d'un autre menu Navi+ (par exemple : sur une tabbar, un FAB dans le coin inférieur de l'écran, ou un mega menu). Principaux objectifs de cette méthode :

<details><summary>Objectif 1 : Amélioration de la visibilité et de l'expérience utilisateur en affichant la carte du site complète dans le menu déroulant tout en restant facile d'accès.</summary>
