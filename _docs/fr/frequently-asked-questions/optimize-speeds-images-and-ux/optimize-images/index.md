---
description: Comment puis-je empêcher mes images d'être compressées lors du téléchargement avec l'outil Navi+ ?
lang: fr
layout: default
permalink: /fr/docs/frequently-asked-questions/optimize-speeds-images-and-ux/optimize-images/
title: Optimiser les images
---
# Optimiser les images

Comment puis-je empêcher mes images d'être compressées lors du téléchargement avec l'outil Navi+ ?

#### I. Pourquoi des tailles d'image plus petites sont-elles meilleures pour le SEO et l'expérience utilisateur ?

Utiliser des tailles d'image plus petites aide votre site web à se charger plus rapidement. Les moteurs de recherche comme Google considèrent la vitesse de chargement des pages comme un facteur de classement important, donc des images optimisées peuvent améliorer votre SEO.

Un chargement plus rapide rend également le site web plus fluide et plus agréable pour les visiteurs, surtout sur les appareils mobiles ou les connexions plus lentes. Cela signifie que les utilisateurs sont plus susceptibles de rester sur votre site et de continuer à explorer vos produits.

#### II. Comment Navi+ traite-t-il vos images ?

Navi+ télécharge d'abord votre image dans sa taille d'origine. Ensuite, il compresse l'image avec un algorithme optimisé et réduit la taille d'affichage. Cette taille est soigneusement choisie par Navi+ pour être idéale à la fois pour l'expérience utilisateur et le SEO, puisque les images dans les menus sont généralement des vignettes ou des icônes qui doivent être petites et se charger rapidement.

**Remarque :** Pour les petites images comme les logos ou les icônes, Navi+ ne les compresse pas pour préserver la netteté.

Après cela, Navi+ stocke votre image sur BunnyCDN — un puissant réseau de distribution de contenu (CDN) pour les images, JavaScript, CSS, et plus encore. BunnyCDN fournit des vitesses de chargement extrêmement rapides grâce à son réseau de serveurs mondial. Cela garantit que votre site web peut gérer des millions de visites sans ralentir ni causer de retards.

#### III. Que dois-je faire si je veux garder mes images à leur qualité d'origine ?

Dans certains cas particuliers, vous pouvez vouloir que Navi+ ne modifie pas la qualité de votre image—sinon, la compression pourrait réduire la qualité que vous attendez, par exemple, certaines images de produits importantes. Dans ce cas, vous devez télécharger l'image directement sur Shopify et fournir le lien à Navi+ pour conserver la qualité d'origine.
...
**Étape 3 : Utilisez l'URL de l'image dans Navi+**\
