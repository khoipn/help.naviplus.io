---
description: Certains méga menus peuvent être très grands. Dans ce cas, l'expansion d'un menu de niveau 3 peut ne pas laisser suffisamment d'espace. Lorsque cela se produit, vous devez épingler le menu de niveau 3 en haut à la place.
lang: fr
layout: default
...
Certains méga menus peuvent être très grands. Dans ce cas, l'expansion d'un menu de niveau 3 peut ne pas laisser suffisamment d'espace. Lorsque cela se produit, vous devez épingler le menu de niveau 3 en haut à la place.
...
Collez-le dans la boîte de feuille de style interne / CSS :
