...
> Après avoir choisi **Remplacer**, envisagez d'ajouter du CSS pour masquer l'élément original pendant le chargement de Navi+ — voir [Publish Optimize](/fr/docs/publish/publish-optimize/).
