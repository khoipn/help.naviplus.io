...
lang: fr
layout: default
permalink: /fr/docs/resources/terms-and-condition/
...
Navi+ ne **stocke pas directement les informations de paiement** et ne traite pas les remboursements lui-même.\ En effectuant un paiement, vous acceptez de vous conformer aux **conditions et politiques de remboursement** respectives du fournisseur de paiement.
...
### 4. Compte et Inscription

Pour utiliser certaines fonctionnalités, vous devrez peut-être créer un compte.\ Vous acceptez de :

* Fournir des informations **précises, complètes et à jour**.
* Garder votre **mot de passe et vos identifiants en sécurité**.
* Être entièrement responsable de toutes les activités sous votre compte.
* Informer Navi+ immédiatement de tout accès non autorisé ou violation de sécurité.

Navi+ se réserve le droit de suspendre ou de résilier tout compte qui semble être **compromis, inactif ou en violation** de ces Conditions ou des lois applicables.

***

### 5. Propriété du Contenu et Licence

Vous conservez l'entière propriété de tout **contenu, images, données et matériaux** téléchargés ou créés lors de l'utilisation de Navi+.
...
Navi+ est fourni “**tel quel**” et “**selon disponibilité**.”\ Nous ne garantissons pas que le Service sera ininterrompu, sans erreur ou compatible avec chaque appareil ou plateforme.

Navi+ ne pourra être tenu responsable de :

* Tout **dommage indirect, accessoire ou consécutif**, 
* La perte de revenus, de données ou d'opportunités commerciales, ou 
* Des problèmes techniques causés par des fournisseurs tiers, des infrastructures ou des actions des utilisateurs.

Dans tous les cas, la responsabilité totale de Navi+ ne devra **pas dépasser le montant que vous avez payé** pour le Service au cours des **douze (12) mois précédents**.

***

### 7. Résiliation du Service

Nous pouvons suspendre ou résilier votre accès à Navi+ à tout moment, sans préavis, si :

1. Vous violez ces Conditions ou les lois applicables.
2. Nous recevons une demande légale de Shopify, Lemon Squeezy ou de toute plateforme partenaire.
3. Le Service nécessite une maintenance, une mise à niveau ou une interruption permanente.

Vous pouvez également résilier votre compte à tout moment en désinstallant l'application ou en contactant le support.

Après résiliation, Navi+ peut conserver certaines données pendant une période limitée pour des raisons techniques ou légales avant suppression permanente.
