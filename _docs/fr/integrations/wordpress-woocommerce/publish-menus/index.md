---
description: Publiez des menus Navi+ sur WordPress en utilisant le plugin Navi+ — les menus collants s'affichent automatiquement sur tout le site, tandis que les menus de section sont placés via le shortcode [naviwp] ou le bloc Gutenberg.
lang: fr
layout: default
