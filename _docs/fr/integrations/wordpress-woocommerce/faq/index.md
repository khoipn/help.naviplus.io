---
description: Frequently asked questions about the Navi+ WordPress plugin — pricing, performance, WooCommerce, multisite, page builders, caching, privacy, and uninstall.
lang: fr
layout: default
...
<p>Le plugin se connecte au service Navi+ pour créer et afficher des menus. Les données échangées peuvent inclure (mais ne sont pas limitées à) : votre <strong>nom de domaine</strong>, votre <strong>configuration de menu</strong>, et des données d'utilisation minimales nécessaires pour afficher les menus.</p>
