---
description: Navi+ est le plugin WordPress officiel pour Navi+. Installez-le, créez des menus dans WordPress et publiez-les sur l'ensemble du site ou via le shortcode [naviwp] — pas d'éditions de code, pas d'injecteurs d'en-tête.
lang: fr
layout: default
...
Si votre site fonctionne sur **WordPress** ou **WooCommerce**, la manière recommandée de publier des menus Navi+ est le plugin officiel **Navi+** sur WordPress.org. Le nom complet de la liste WordPress.org est **Naviplus Menu Builder**.
...
Trois méthodes d'installation sont détaillées sur la page d'installation dédiée : **[Installer le plugin Navi+]({{ site.baseurl }}/docs/integrations/wordpress-woocommerce/install-plugin/)** — recherche admin (recommandée), téléchargement ZIP, ou FTP / gestionnaire de fichiers.
...
3. Concevez la mise en page dans l'**éditeur visuel Navi+**, ouvert depuis le tableau de bord WordPress.
...
Le plugin se connecte au service Navi+ pour créer et **rendre** vos menus. Les données échangées peuvent inclure (sans limitation) : votre **domaine de site**, votre **configuration de menu**, et des données d'utilisation minimales nécessaires pour le rendu.
...
| Politique de confidentialité | <https://naviplus.io/privacy> |
| FAQ du plugin (ce site) | [Navi+ FAQ]({{ site.baseurl }}/docs/integrations/wordpress-woocommerce/faq/) |
