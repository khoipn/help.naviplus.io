---
description: 您需要使用像TourGuideJS这样的库，这是一个可以嵌入到您的网站中的JavaScript库，以通过属性格式添加逐步引导，例如<div data-tg-tour="<span>我的第一次旅游</span>"> ... </div>。它是完全免费的。请按照以下说明通过Navi+菜单添加引导，无论是针对整个菜单还是单个菜单项。
lang: zh-cn
layout: default
...
您需要使用像TourGuideJS这样的库，这是一个可以嵌入到您的网站中的JavaScript库，以通过属性格式添加逐步引导，例如<div data-tg-tour="<span>我的第一次旅游</span>"> ... </div>。它是完全免费的。请按照以下说明通过Navi+菜单添加引导，无论是针对整个菜单还是单个菜单项。
