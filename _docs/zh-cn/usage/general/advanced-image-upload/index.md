...
之后，Navi+将您的图像存储在BunnyCDN上——一个强大的内容交付网络（CDN），用于图像、JavaScript、CSS等。BunnyCDN通过其全球服务器网络提供极快的加载速度。这确保您的网站可以处理数百万的访问而不会减慢或造成延迟。
...
**步骤3：在Navi+中使用图像URL**\
将步骤2中获得的URL粘贴到Navi+中，使用 **Upload Image** 工具。
