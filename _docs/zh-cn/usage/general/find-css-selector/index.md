---
description: '**CSS 选择器** 是 CSS 中一个非常有趣的概念——它定义了您网站的哪个部分可以被 **替换** 或 **插入 Navi+ 菜单**（无论是 *在它之前* 还是 *在它之后*）。'
lang: zh-cn
layout: default
permalink: /zh-cn/docs/usage/general/find-css-selector/
title: 查找 CSS 选择器
---
# 查找 CSS 选择器
