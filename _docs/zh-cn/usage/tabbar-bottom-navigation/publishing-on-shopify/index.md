...
lang: zh-cn
layout: default
permalink: /zh-cn/docs/usage/tabbar-bottom-navigation/publishing-on-shopify/
title: 在 Shopify 上发布
---
# 在 Shopify 上发布
...
* 如果您的网站是新的且还没有用户，请随意发布菜单而无需担心——您可以随时轻松地打开或关闭它，而不会影响访客。
...
经过这 4 个步骤，Navi+ 已经安装在您的网站上并准备显示。然而，过程尚未完成。返回 Navi+ 应用标签以实际打开**发布菜单**。
