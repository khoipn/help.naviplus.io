...
> **在WordPress上？** 使用专用的 [Naviplus Menu Builder plugin]({{ site.baseurl }}/docs/usage/mega-menu-desktop/publish-on-wordpress/) 而不是下面的手动嵌入 — 无需编辑主题，通过短代码或Gutenberg块放置Mega Menu。
