...
步骤 3：转到应用嵌入，找到“在所有页面上使用的 Navi+”，并将其打开。
...
完成这 4 个步骤后，Navi+ 已经安装在您的网站上并准备显示。然而，过程尚未完成。返回到 Navi+ 应用标签以实际开启**发布菜单**。
...
当您用一个菜单替换另一个菜单时，Navi+ 会等待旧菜单显示，然后立即用新菜单替换它。尽管这几乎是立即发生的，但仍然会有一个短暂的时刻，旧菜单会出现，这可能会让用户感到困惑。
