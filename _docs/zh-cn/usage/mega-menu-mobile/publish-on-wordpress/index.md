---
description: Publish a Navi+ Mega Menu (Mobile) on WordPress with the Navi+ plugin. Insert it where it should appear via the [naviwp embed_id="..."] shortcode or Gutenberg block.
lang: zh-cn
layout: default
permalink: /zh-cn/docs/usage/mega-menu-mobile/publish-on-wordpress/
title: 在 WordPress 上发布
---
# 在 WordPress 上发布

A **Mega Menu (Mobile)** is a **section** menu — it renders at the spot in the page where you embed it. On WordPress, the Navi+ plugin places it via shortcode or Gutenberg block; you never edit theme files.
