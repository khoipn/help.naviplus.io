---
description: '**移动 Mega 菜单** 在移动设备上并不像 Tabbar 或 Slide Menus 那样常见，因为 Mega 菜单的点击区域通常对用户的手指来说太小。然而，有时您可能希望通过在桌面和移动平台上使用 Mega 菜单来保持一致的体验。'
lang: zh-cn
layout: default
permalink: /zh-cn/docs/usage/mega-menu-mobile/how-to-use/
title: 如何使用？
---
# 如何使用？

**移动 Mega 菜单** 在移动设备上并不像 Tabbar 或 Slide Menus 那样常见，因为 Mega 菜单的点击区域通常对用户的手指来说太小。然而，有时您可能希望通过在桌面和移动平台上使用 Mega 菜单来保持一致的体验。

移动 Mega 菜单也有其优势：它们紧凑，位于标题下方，并且不会占用屏幕空间，因为它们浮动在屏幕上。作为一个部分菜单，它们会随着页面滚动。
...
<p>您应该创建<strong>多个菜单</strong>。只有<strong>活动</strong>菜单会在您的网站上显示，但您可以准备多个版本——通过选择不同的模板或克隆菜单。菜单可以根据页面类型（主页、产品、集合...）、设备（移动或桌面）或 URL 关键字进行配置以显示/隐藏。因此，继续构建适合每种情况的菜单吧！</p>
</details>
...
这是一个 3 级菜单树。第 1 级包括 **菜单、主页**、**目录**、**支持、博客** 和 **更多**。  
**全山** 是一个第 2 级菜单项，具有一些子项：**巡航灵活** 和 **平衡骑行**。

您将花费大部分时间来构建此菜单树，以帮助客户找到他们所寻找的内容。

<figure><img src="https://4226540503-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F4y2gLTmg4ToH5vkorG8s%2Fuploads%2FosZUYAtOckjPUD5T8F5q%2FHelp.MenuTree.1.1.0.png?alt=media&#x26;token=c1eec6d7-a0b6-45f5-aea5-6678540a884a" alt="目录：一个第 1 级菜单项，显示为选项卡上的标签。全山：第 2 级菜单项，当您点击目录时出现。"><figcaption></figcaption></figure>

<figure><img src="https://4226540503-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F4y2gLTmg4ToH5vkorG8s%2Fuploads%2Fh6AHpLQvuPq0AadY0TOH%2FHelp.MenuTree.1.1.1.png?alt=media&#x26;token=06a10cb0-ab20-44be-a734-a221597a4ea9" alt="巡航灵活、平衡骑行：第 3 级菜单项，当您点击全山时出现。"><figcaption></figcaption></figure>
...
这是使用 Navi+ 创建菜单时的常见情况。当您创建新菜单时，我们会包含一个完整的示例，带有流行的菜单项，以展示布局想法并让您根据需要复制/粘贴。然而，如果您是 Navi+ 的新用户并使用 Starter 计划，您会看到许多红色 (i) 警告，表示某些功能不可用，例如上传图像或使用高级交互。
