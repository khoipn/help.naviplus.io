...
lang: zh-cn
layout: default
permalink: /zh-cn/docs/usage/mega-menu-mobile/publishing-on-shopify/
title: 在 Shopify 上发布
---
# 在 Shopify 上发布
...
在本指南中，我们将重点介绍 2 种方法：在页眉下方插入此菜单或替换默认的 Mega Menu。您还可以通过查找和应用其他 CSS 选择器来创造性地使用此方法以触发菜单。
...
- 或者，您可以按照下一个主题中的自助指南（在此主题之后）。
</code></pre>
</details>

<details><summary>如何替换默认的 Mega Menu？</summary>
<p>在移动设备上，没有 Mega Menu 可供替换，因此此方法通常不可行</p>
</details>
...
<p>以下是将 Navi+ 菜单作为部分/区块插入您的 Shopify 主题的详细指南。此方法允许您以标准的、 Shopify 支持的方式添加菜单，尽管它不如 Navi+ 提供的其他方法灵活。</p>
