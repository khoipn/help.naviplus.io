---
description: 在这里，您将找到如何将Navi+与其他应用程序（如聊天工具、忠诚度等）连接的指南。您可以将它们添加为菜单项，直接从Navi+打开应用程序，并确保一切顺利协同工作，而不会在您的网站上重叠。
lang: zh-cn
layout: default
...
在这里，您将找到如何将Navi+与其他应用程序（如聊天工具、忠诚度等）连接的指南。您可以将它们添加为菜单项，直接从Navi+打开应用程序，并确保一切顺利协同工作，而不会在您的网站上重叠。
...
• 步骤1：使用CSS隐藏粘性应用程序图标。详细信息请参见这里\
• 步骤2：使用JavaScript为菜单项，以便单击它们时打开相应的应用程序面板。
