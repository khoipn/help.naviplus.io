---
description: 目前，Navi+ 支持一系列流行主题以打开汉堡菜单、购物车和搜索面板。对于不在此列表中的主题，您可以请求 Navi+ 添加支持（周转时间：1 个工作日）。
lang: zh-cn
layout: default
...
目前，Navi+ 支持一系列流行主题以打开汉堡菜单、购物车和搜索面板。对于不在此列表中的主题，您可以请求 Navi+ 添加支持（周转时间：1 个工作日）。
