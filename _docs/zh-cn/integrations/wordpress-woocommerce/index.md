---
description: Navi+ is the official WordPress plugin for Navi+. Install it, build menus inside WordPress, and publish them site-wide or via the [naviwp] shortcode — no code edits, no header injectors.
lang: zh-cn
layout: default
permalink: /zh-cn/docs/integrations/wordpress-woocommerce/
