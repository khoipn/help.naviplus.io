---
description: 一些 Mega menu 可能非常高。在这种情况下，展开 3 级菜单可能不会留出足够的空间。当这种情况发生时，您应该将 3 级菜单固定在顶部。
lang: zh-cn
layout: default
permalink: /zh-cn/docs/frequently-asked-questions/customize-user-interface-ui/align-level-3-submenu-in-mega-menu/
title: 在 Mega menu 中对齐 3 级子菜单？
---
# 在 Mega menu 中对齐 3 级子菜单？

一些 Mega menu 可能非常高。在这种情况下，展开 3 级菜单可能不会留出足够的空间。当这种情况发生时，您应该将 3 级菜单固定在顶部。
