---
description: 如何在使用Navi+工具上传时防止图像被压缩？
lang: zh-cn
layout: default
...
**注意：** 对于像徽标或图标这样的小图像，Navi+不会对其进行压缩以保持清晰度。
...
在某些特殊情况下，您可能希望Navi+不修改您的图像质量——否则，压缩可能会降低您期望的质量，例如某些重要的产品图像。在这种情况下，您需要直接将图像上传到Shopify，并提供链接给Navi+以保持原始质量。
...
**步骤2：上传到Shopify**\
右键单击菜单 **Content**，选择 **Open link in new Tab**，然后转到 **Files**。将步骤1中准备的图像拖放到此处。上传后，在列表中找到您的文件并单击链接图标以复制其URL。此URL将在Navi+中用于上传图像。
...
**步骤3：在Navi+中使用图像URL**\
使用 **Upload Image** 工具将步骤2中获得的URL粘贴到Navi+中。
