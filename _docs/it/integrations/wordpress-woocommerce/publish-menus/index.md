---
description: Pubblica i menu Navi+ su WordPress utilizzando il plugin Navi+ — i menu sticky vengono visualizzati automaticamente su tutto il sito, mentre i menu di sezione vengono posizionati tramite il shortcode [naviwp] o il blocco Gutenberg.
lang: it
layout: default
