---
description: Domande frequenti sul plugin WordPress Navi+ — prezzi, prestazioni, WooCommerce, multisite, page builders, caching, privacy e disinstallazione.
lang: it
layout: default
...
<p>Il plugin si connette al servizio Navi+ per creare e visualizzare i menu. I dati scambiati possono includere (ma non sono limitati a): il tuo <strong>dominio del sito</strong>, la tua <strong>configurazione del menu</strong> e dati minimi di utilizzo necessari per visualizzare i menu.</p>
