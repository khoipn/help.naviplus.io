---
description: Installa il plugin Navi+ sul tuo sito WordPress o WooCommerce — dal directory di WordPress.org, un upload ZIP, FTP o WP-CLI.
lang: it
layout: default
permalink: /it/docs/integrations/wordpress-woocommerce/install-plugin/
title: Installa il plugin Navi+
---
# Installa il plugin Navi+

> Il nome completo del plugin su WordPress.org è **Naviplus Menu Builder**. Nel resto di questi documenti è riferito come **Navi+** (o semplicemente **Navi+**).
