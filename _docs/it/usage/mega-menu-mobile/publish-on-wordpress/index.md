---
description: Pubblica un Navi+ Mega Menu (Mobile) su WordPress con il plugin Navi+. Inseriscilo dove dovrebbe apparire tramite il shortcode [naviwp embed_id="..."] o blocco Gutenberg.
lang: it
layout: default
...
A **Mega Menu (Mobile)** è un **menu** di sezione — viene visualizzato nel punto della pagina in cui lo incorpori. Su WordPress, il plugin Navi+ lo posiziona tramite shortcode o blocco Gutenberg; non modifichi mai i file del tema.
