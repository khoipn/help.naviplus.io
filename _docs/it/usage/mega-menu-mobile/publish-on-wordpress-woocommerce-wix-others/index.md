...
> **Sei su WordPress?** Usa il plugin dedicato [Naviplus Menu Builder]({{ site.baseurl }}/docs/usage/mega-menu-mobile/publish-on-wordpress/) invece dell'embed manuale qui sotto — nessuna modifica al tema, posiziona il Mega Menu tramite shortcode o blocco Gutenberg.
...
> **Su Wix?** Vedi la guida dedicata [Pubblica su Wix](/it/docs/usage/mega-menu-mobile/publishing-on-wix/) — installa l'app Navi+ dal Wix App Market e si incorpora automaticamente, nessun codice. L'embed manuale qui sotto è solo per Squarespace, Webflow e siti personalizzati.
