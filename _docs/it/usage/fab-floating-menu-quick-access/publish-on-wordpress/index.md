---
description: 'Pubblica un Navi+ FAB (Floating Action Button) su WordPress con il plugin Navi+. Il FAB è un menu appiccicoso: una volta pubblicato nell''editor, appare automaticamente su tutto il sito.'
lang: it
layout: default
...
A **FAB (Floating Action Button)** è un **menu appiccicoso** — fluttua sopra la pagina (tipicamente in un angolo) e rimane fermo mentre i visitatori scorrono. Su WordPress, il plugin Navi+ lo rende automaticamente visibile su tutto il sito; non è necessario incollare alcun codice o shortcode.
