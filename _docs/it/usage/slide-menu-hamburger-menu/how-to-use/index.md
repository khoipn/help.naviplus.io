---
description: '**Slide Menu**—noto anche come Hamburger Menu, Sidebar Menu o Drawer Menu—è comunemente usato sui siti web Shopify adattando il menu desktop per mobile. Tipicamente...'
lang: it
layout: default
permalink: /it/docs/usage/slide-menu-hamburger-menu/how-to-use/
title: Come usare?
---
# Come usare?

**Slide Menu**—noto anche come Hamburger Menu, Sidebar Menu o Drawer Menu—è comunemente usato sui siti web Shopify adattando il menu desktop per mobile. Tipicamente, questo menu predefinito è semplice, senza immagini o layout avanzati. Navi+ offre una sostituzione completa per quel menu predefinito di base.
...
Ecco un esempio di un albero del menu di Slide menu:
