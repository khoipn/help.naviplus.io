...
lang: it
layout: default
permalink: /it/docs/usage/slide-menu-hamburger-menu/publish-on-wordpress-woocommerce-wix-others/
title: Pubblica su Squarespace / Altri
---
# Pubblica su Squarespace / Altri

> **Sei su WordPress?** Usa il plugin dedicato [Naviplus Menu Builder]({{ site.baseurl }}/docs/usage/slide-menu-hamburger-menu/publish-on-wordpress/) invece dell'embed manuale qui sotto — nessuna modifica al tema, il plugin apre il Slide Menu da qualsiasi selettore CSS tu scelga nell'editor.
...
> **Su Wix?** Vedi la guida dedicata [Pubblica su Wix](/it/docs/usage/slide-menu-hamburger-menu/publishing-on-wix/) — installa l'app Navi+ dal Wix App Market e si incorpora automaticamente, nessun codice. L'embed manuale qui sotto è solo per Squarespace, Webflow e siti personalizzati.

Questa pagina tratta il metodo **embed manuale dello script**, che è il percorso giusto per [Squarespace](https://www.squarespace.com/ "Squarespace"), [Webflow](https://webflow.com/ "Webflow"), [Magento](https://magento-opensource.com/ "Magento"), e siti web personalizzati costruiti con PHP, Node.js, o puro HTML. Hai i seguenti metodi di implementazione:
