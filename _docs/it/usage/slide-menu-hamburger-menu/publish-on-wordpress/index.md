---
description: Pubblica un Navi+ Slide Menu (hamburger) su WordPress con il plugin Navi+. Il plugin carica il menu su tutto il sito e il trigger è configurato all'interno dell'editor Navi+ — nessuna modifica al tema, nessun shortcode per la configurazione tipica.
lang: it
layout: default
