---
description: '**Il selettore CSS** è un concetto molto interessante in CSS — definisce quale parte del tuo sito web può essere **sostituita** o **avere un menu Navi+ inserito** (sia *prima* che *dopo* di esso).'
lang: it
layout: default
...
**Il selettore CSS** è un concetto molto interessante in CSS — definisce quale parte del tuo sito web può essere **sostituita** o **avere un menu Navi+ inserito** (sia *prima* che *dopo* di esso).
...
.footer           /* La sezione del piè di pagina */
.main-content     /* Il contenitore del contenuto principale */
.product-gallery  /* La sezione delle immagini del prodotto */
div#menu-wrapper  /* Un div specifico con ID “menu-wrapper” */
