---
description: '**Selettore CSS** è un concetto molto interessante in CSS — definisce quale parte del tuo sito web può essere **sostituita** o **avere un menu Navi+ inserito** (sia *prima* che *dopo* di essa).'
lang: it
layout: default
