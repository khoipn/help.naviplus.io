...
Per esempio, immagina di avere una Tabbar di Navi+ mostrata sul tuo sito web con 3 lingue: English (predefinito), French e Vietnamese. Il codice breve per il francese è `fr` e per il vietnamita è `vi`.
...
* **Passo 1:** (Opzionale) Aggiungi icone di bandiera se vuoi. Puoi scaricare icone di bandiera da siti web come [Flaticon](https://www.flaticon.com "Flaticon") (Per esempio: <https://www.flaticon.com/authors/flags/rectangular?author_id=1&type=standard>). 
