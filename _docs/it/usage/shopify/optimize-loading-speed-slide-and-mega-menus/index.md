---
description: Navi+ è molto veloce. È completamente distribuito su un CDN leader con latenza molto bassa (circa 100ms) e può servire milioni di clienti senza rallentare.
lang: it
layout: default
permalink: /it/docs/usage/shopify/optimize-loading-speed-slide-and-mega-menus/
title: Ottimizza la velocità di caricamento (Slide & Mega menu)
---
# Ottimizza la velocità di caricamento (Slide & Mega menu)

#### Perché hai bisogno di farlo? Navi+ non è già veloce?

Navi+ è molto veloce. È completamente distribuito su un CDN leader con latenza molto bassa (circa 100ms) e può servire milioni di clienti senza rallentare.
