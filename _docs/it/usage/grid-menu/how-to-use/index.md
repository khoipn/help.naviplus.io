---
description: '**Grid Menu** è un tipo di menu popolare utilizzato in molte app e siti web di e-commerce. Di solito visualizza cataloghi o funzionalità chiave ed è spesso mostrato sulla home...'
lang: it
layout: default
permalink: /it/docs/usage/grid-menu/how-to-use/
title: Come usare?
---
# Come usare?

**Grid Menu** è un tipo di menu popolare utilizzato in molte app e siti web di e-commerce. Di solito visualizza cataloghi o funzionalità chiave ed è spesso mostrato sulla homepage.

Mobile  Grid menu occupano spazio sullo schermo poiché fluttuano sullo schermo. Come menu di sezione, scorrono insieme alla pagina.
...
<p>Assolutamente! I gruppi di menu servono principalmente ad aiutare i principianti a non sentirsi sopraffatti dalle funzionalità avanzate in Navi+ 😄.\
Il modo migliore è provare i menu professionali per esplorare tutte le funzionalità e le opzioni di layout. In seguito, puoi semplicemente eliminare qualsiasi menu di cui non hai bisogno o che trovi inadeguato.</p>
</details>
...
<p>Nessun problema. Puoi eliminarlo e crearne uno nuovo in qualsiasi momento.\
Se stai testando un menu e vuoi provare un altro modello, puoi <strong>salvare</strong> quello attuale come file di backup e riaprirlo in seguito.\
Puoi persino <strong>copiare e incollare</strong> parti tra i menu (aprendo due schede del browser) per mantenere il tuo lavoro precedente. Sentiti libero di sperimentare!</p>
</details>

<details><summary><strong>4. Dovrei creare solo un menu o più?</strong></summary>
<p>Dovresti creare <strong>più menu</strong>.\
Solo il menu <strong>attivo</strong> verrà mostrato sul tuo sito, ma puoi preparare molte versioni — selezionando modelli diversi o clonando menu.\
I menu possono essere configurati per mostrare/nascondere in base al tipo di pagina (home, prodotto, collezione...), dispositivo (mobile o desktop) o parole chiave URL.\
Quindi vai avanti e costruisci menu che si adattino a ogni situazione!</p>
</details>
...
Ecco un esempio di un albero del menu di un menu grid mobile:
...
Questo è un albero del menu a 1 livello. I menu Grid non supportano più livelli di menu per mantenere la semplicità..

Trascorrerai la maggior parte del tuo tempo a costruire questo albero del menu per il tuo sito web, aiutando i clienti a trovare i contenuti che stanno cercando.
