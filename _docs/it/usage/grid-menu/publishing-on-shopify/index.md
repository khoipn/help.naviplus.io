...
<p>Di seguito è riportata una guida dettagliata su come inserire un menu Navi+ come sezione/blocco nel tuo tema Shopify. Questo metodo ti consente di aggiungere il menu in un modo standard, supportato da Shopify, anche se non è così flessibile come gli altri metodi forniti da Navi+.</p>
