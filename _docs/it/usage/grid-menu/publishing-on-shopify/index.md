...
In questa guida, ci concentreremo su 1 modo: inserire questo menu prima del principale. Puoi anche utilizzare questo metodo in modo creativo trovando e applicando altri selettori CSS per attivare il menu.

<details><summary>Come inserire questo menu prima del principale del sito web<strong>?</strong></summary>
...
<pre class="codehilite"><code>- Puoi chattare con un sostenitore di Navi+ per ricevere aiuto immediato: ci vogliono solo pochi minuti per trovare il selettore CSS.

- Oppure, puoi seguire la guida di auto-aiuto nei prossimi argomenti (Subito dopo questo argomento).
</code></pre>
</details>

<details><summary>Come sostituire il Menu a Griglia predefinito?</summary>
<p>Su mobile, non c'è un Menu a Griglia da sostituire, quindi questo metodo di solito non è fattibile</p>
</details>

<details><summary><strong>Come trovare il selettore CSS sul tuo sito web?</strong></summary>
<p>Puoi chattare con un sostenitore di Navi+ per ricevere aiuto immediato invece di farlo da solo.\
...
<p>Questo metodo si applica a <strong>Mega Menus</strong> e <strong>Grid Menus</strong>. Non si applica a <strong>Tabbar</strong>, <strong>FAB</strong> o <strong>Slide Menus</strong>.</p>
