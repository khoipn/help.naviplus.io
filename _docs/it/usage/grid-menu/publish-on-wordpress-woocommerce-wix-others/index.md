...
> **Su Wix?** Vedi la guida dedicata [Pubblica su Wix](/it/docs/usage/grid-menu/publishing-on-wix/) — installa l'app Navi+ dal Wix App Market e si incorpora automaticamente, nessun codice. L'embed manuale qui sotto è solo per Squarespace, Webflow e siti personalizzati.
