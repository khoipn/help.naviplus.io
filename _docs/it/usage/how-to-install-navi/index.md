...
**Wix:** Installa Navi+ dal [Wix App Market](https://www.wix.com/app-market). Si apre all'interno della tua dashboard Wix e si incorpora automaticamente nel tuo sito live — nessun codice da copiare, nessuno snippet da incorporare. L'autenticazione e la fatturazione sono gestite tramite Wix.
