---
description: '**Stai costruendo siti web Shopify per i clienti? Diventa un Partner Navi+ e guadagna fino al 22,5% di commissione!**'
lang: it
layout: default
permalink: /it/docs/partership/earn-up-to-225-revshare-with-navi/
title: Guadagna fino al 22,5% di RevShare con Navi+
---
# Guadagna fino al 22,5% di RevShare con Navi+

**Stai costruendo siti web Shopify per i clienti? Diventa un Partner Navi+ e guadagna fino al 22,5% di commissione!**

Se sei un freelance, un'agenzia o un esperto di Shopify, non perdere l'occasione di generare un reddito ricorrente da ogni progetto che consegni.

Con il Programma RevShare di Navi+, otterrai:

* Fino al 22,5% di commissione basata sul fatturato mensile o annuale dei tuoi clienti (Il fatturato generato continuerà fino a quando il cliente non utilizza più il servizio): 18% dal tuo 2° al 7° cliente referito, e poi **22,5%** dal tuo 8° cliente in poi
* Pagamenti trimestrali tramite PayPal o bonifico bancario.
* Accesso anticipato a nuove funzionalità, suggerimenti e risorse di supporto dal team di Navi+.

**👉 Come unirsi?** Inviami un'email a <khoipng@gmail.com> o chatta con me per verificare e attivare il tuo stato di Partner Navi+. L'email includerà: Termini e condizioni del programma, Processo di verifica del cliente, Come funziona il tracciamento delle commissioni e del fatturato.

**👉 Perché Navi+ è la migliore opzione?**
