...
| # | Argomento | |
|---|---|---|
| 1 | Sistema di ereditarietà e meccanismo di override (leggere prima) | [Panoramica Design](/it/docs/design/design-overview/) |
| 2 | Livello 1 — Aspetto degli elementi di menu principale | [Design Livello 1](/it/docs/design/design-level1/) |
| 3 | Livello 2-3 — Aspetto dei sottomenu | [Design Livello 2-3](/it/docs/design/design-level2/) |
| 4 | Divider — Linee di separazione | [Design Divider](/it/docs/design/design-divider/) |
