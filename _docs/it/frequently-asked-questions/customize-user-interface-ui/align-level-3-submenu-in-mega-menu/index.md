---
description: Alcuni mega menu possono essere molto alti. In tal caso, espandere un menu di livello 3 potrebbe non lasciare abbastanza spazio. Quando ciò accade, dovresti fissare il menu di livello 3 in cima invece.
lang: it
layout: default
permalink: /it/docs/frequently-asked-questions/customize-user-interface-ui/align-level-3-submenu-in-mega-menu/
title: Allineare il sottomenu di livello 3 nel mega menu?
---
# Allineare il sottomenu di livello 3 nel mega menu?

Alcuni mega menu possono essere molto alti. In tal caso, espandere un menu di livello 3 potrebbe non lasciare abbastanza spazio. Quando ciò accade, dovresti fissare il menu di livello 3 in cima invece.
...
Incollalo nella casella Foglio di stile interno / CSS:
