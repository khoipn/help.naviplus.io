...
title: Come trasferire un menu Navi+ a un altro menu Navi+
---
...
### Quando avresti bisogno di trasferire un menu?
...
Apri entrambi i menu nello stesso browser (ad esempio, Chrome):

* Una scheda: Menu sorgente (il menu che ha già contenuto)
* Una scheda: Menu di destinazione (il menu in cui stai trasferendo)

Tenerli aperti affiancati renderà il processo più veloce e aiuterà a evitare errori.
...
#### Passo 3: Copia dal menu sorgente

Nella scheda del menu sorgente, seleziona gli elementi di menu che desideri spostare e fai clic sul pulsante COPIA.
...
#### Passo 4: Incolla nel menu di destinazione

Passa alla scheda del menu di destinazione, naviga nella posizione corretta e incolla gli elementi di menu copiati.
