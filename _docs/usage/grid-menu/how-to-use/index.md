...
Here’s an example of a menu tree of mobile grid menu:
...
This is a 1 level menu tree. Grid Menus do not support multiple menu levels to maintain simplicity..
...
```
GET https://help.shopifas.com/manual/website/help.naviplus.io/usage/grid-menu/how-to-use.md?ask=<question>
```
