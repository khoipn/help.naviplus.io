...
layout: default
permalink: /docs/usage/grid-menu/publish-on-wordpress-woocommerce-wix-others/
title: Publish on Squarespace / Others
---
# Publish on Squarespace / Others

> **On WordPress?** Use the dedicated [Naviplus Menu Builder plugin]({{ site.baseurl }}/docs/usage/grid-menu/publish-on-wordpress/) instead of the manual embed below — no theme edits, place the Grid via shortcode or Gutenberg block.
...
> **On Wix?** See the dedicated **[Publish on Wix]({{ site.baseurl }}/docs/usage/grid-menu/publishing-on-wix/)** guide — install the Navi+ app from the Wix App Market and it embeds automatically, no code. The manual embed below is only for Squarespace, Webflow, and custom sites.
