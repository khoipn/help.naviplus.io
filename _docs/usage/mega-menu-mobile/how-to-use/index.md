...
**Mobile Mega Menus** are not as common on mobile as Tabbar or Slide Menus, because the tap area of a Mega Menu is often too small for users’ fingers. However, sometimes you may want to maintain a consistent experience between desktop and mobile by using a Mega Menu on both platforms.

Mobile Mega Menus also have advantages: they are compact, positioned below the header, and don’t take up screen space since they float on the screen. As a section menu, they scroll along with the page.

**Key Benefits:**

* Works seamlessly on both mobile and desktop for a consistent experience
* Saves space and scrolls with the page.
...
Here’s an example of a menu tree of mobile mega menu:
...
This is a 3 level menu tree. Level-1 includes **Menu, Home**, **Catalog**, **Support, Blogs** and **More**.\
**All-Mountain** is a level-2 menu item, with some child items: **Cruise Flex** and **Balance Ride**.
...
```
GET https://help.shopifas.com/manual/website/help.naviplus.io/usage/mega-menu-mobile/how-to-use.md?ask=<question>
```
