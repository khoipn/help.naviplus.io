...
**Slide Menu**—also known as Hamburger Menu, Sidebar Menu, or Drawer Menu—is commonly used on Shopify websites by adapting the desktop menu for mobile. Typically, this default menu is simple, without images or advanced layouts. Navi+ offers a complete replacement for that basic default menu.

**Key Benefits:**

* Fully replaces Shopify’s simple default menu
...
Here’s an example of a menu tree of Slide menu:
...
```
GET https://help.shopifas.com/manual/website/help.naviplus.io/usage/slide-menu-hamburger-menu/how-to-use.md?ask=<question>
```
