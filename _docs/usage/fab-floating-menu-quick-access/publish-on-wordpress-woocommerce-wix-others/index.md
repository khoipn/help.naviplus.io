...
> **On WordPress?** Use the dedicated [Naviplus Menu Builder plugin]({{ site.baseurl }}/docs/usage/fab-floating-menu-quick-access/publish-on-wordpress/) instead of the manual embed below — no theme edits, the FAB renders site-wide automatically once published in the editor.
...
> **On Wix?** See the dedicated **[Publish on Wix]({{ site.baseurl }}/docs/usage/fab-floating-menu-quick-access/publishing-on-wix/)** guide — install the Navi+ app from the Wix App Market and it embeds automatically, no code. The manual embed below is only for Squarespace, Webflow, and custom sites.
