...
* あなたのウェブサイトが新しく、まだユーザーがいない場合は、心配せずにメニューを公開できます—訪問者に影響を与えることなく、いつでも簡単にオンまたはオフにできます。
...
このガイドでは、2つの方法に焦点を当てます: ヘッダーの下にこのメニューを挿入するか、デフォルトのMega Menuを置き換えることです。この方法を創造的に使用して、メニューをトリガーする他のCSSセレクターを見つけて適用することもできます。
...
<p>Navi+サポーターとチャットして即座にヘルプを得ることができますが、自分でやる代わりに。\
...
<p>この方法は<strong>Mega Menus</strong>および<strong>Grid Menus</strong>に適用されます。これは<strong>Tabbar</strong>、<strong>FAB</strong>、または<strong>Slide Menus</strong>には適用されません。</p>
