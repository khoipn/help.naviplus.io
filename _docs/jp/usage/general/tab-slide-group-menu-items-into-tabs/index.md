---
description: すべてのメニュー項目を一度に表示するのではなく、**タブスライド**を使用すると、メニューをグループに整理し、各グループを別々のタブの下に配置できます。訪問者は単にタブをタップしてグループ間を切り替えることができ、長いメニューをクリーンでコンパクト、かつナビゲートしやすくします。
lang: jp
layout: default
...
すべてのメニュー項目を一度に表示するのではなく、**タブスライド**を使用すると、メニューをグループに整理し、各グループを別々のタブの下に配置できます。訪問者は単にタブをタップしてグループ間を切り替えることができ、長いメニューをクリーンでコンパクト、かつナビゲートしやすくします。
