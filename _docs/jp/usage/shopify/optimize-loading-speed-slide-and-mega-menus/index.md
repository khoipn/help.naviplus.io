---
description: Navi+は非常に高速です。非常に低いレイテンシ（約100ms）を持つ主要なCDNに完全に展開されており、数百万の顧客に対して遅延なくサービスを提供できます。
lang: jp
layout: default
permalink: /jp/docs/usage/shopify/optimize-loading-speed-slide-and-mega-menus/
title: 読み込み速度の最適化 (スライド & メガメニュー)
---
# 読み込み速度の最適化 (スライド & メガメニュー)

#### なぜこれを行う必要があるのですか？Navi+はすでに速くないですか？

Navi+は非常に高速です。非常に低いレイテンシ（約100ms）を持つ主要なCDNに完全に展開されており、数百万の顧客に対して遅延なくサービスを提供できます。
...
* 両方のプラットフォームに適用したい場合は、接尾辞を残してください。
