...
> **WordPressの場合？** 手動埋め込みの代わりに専用の[Naviplus Menu Builderプラグイン]({{ site.baseurl }}/docs/usage/slide-menu-hamburger-menu/publish-on-wordpress/)を使用してください — テーマの編集は不要で、プラグインはエディタで選択した任意のCSSセレクタからスライドメニューを開きます。
