---
description: Navi+は非常に高速です。非常に低いレイテンシ（約100ms）で先進的なCDNに完全に展開されており、数百万の顧客に対して遅延なくサービスを提供できます。
lang: jp
layout: default
...
Navi+は非常に高速です。非常に低いレイテンシ（約100ms）で先進的なCDNに完全に展開されており、数百万の顧客に対して遅延なくサービスを提供できます。
