---
description: Navi+は非常に高速です。非常に低いレイテンシ（約100ms）で、主要なCDNに完全に展開されており、数百万の顧客に対して遅延することなくサービスを提供できます。
lang: jp
layout: default
...
Navi+は非常に高速です。非常に低いレイテンシ（約100ms）で、主要なCDNに完全に展開されており、数百万の顧客に対して遅延することなくサービスを提供できます。
...
* 両方のプラットフォームに適用したい場合は、接尾辞を付けないでください。
