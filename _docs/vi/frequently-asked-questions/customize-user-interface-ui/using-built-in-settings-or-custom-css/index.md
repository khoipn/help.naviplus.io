...
1) Để cấu hình giao diện của toàn bộ menu ở cấp độ cao nhất, bạn có thể viết một đoạn mã không phải CSS tiêu chuẩn nhưng rất đơn giản. Ví dụ, đoạn mã dưới đây thay đổi nền menu thành màu đỏ. Thêm mã sau vào hộp văn bản Internal Stylesheet / CSS:
...
2) Cấu hình kích thước, kiểu chữ và màu sắc cho mỗi cấp độ mục menu. Thêm mã sau vào hộp văn bản Internal Stylesheet / CSS:
...
3) Thay đổi độ dày phông chữ bằng cách sử dụng `font-weight.` Thêm mã sau vào hộp văn bản Internal Stylesheet / CSS:
...
4) Điều chỉnh kích thước của mũi tên. Thêm mã sau vào hộp văn bản Internal Stylesheet / CSS:
