---
description: Mặc định, Navi+ kiểm tra URL của trang hiện tại để hiển thị trạng thái hoạt động trên menu (sử dụng nền xám). Điều này giúp khách hàng của bạn điều hướng dễ dàng hơn.
lang: vi
layout: default
...
Mặc định, Navi+ kiểm tra URL của trang hiện tại để hiển thị trạng thái hoạt động trên menu (sử dụng nền xám). Điều này giúp khách hàng của bạn điều hướng dễ dàng hơn.
...
Phương pháp 1: Nếu bạn muốn áp dụng nó chỉ cho menu này, mã CSS như sau (dán vào hộp Internal Stylesheet / CSS):
...
Phương pháp 2: Nếu bạn muốn xóa tất cả các hiệu ứng hoạt động trên tất cả các menu của Navi+, hãy sử dụng mã sau (dán vào hộp Global Stylesheet / CSS):
