---
description: Sau khi kích hoạt plugin Navi+, mở Giao diện → Naviplus Menu Builder, tạo menu đầu tiên của bạn trong trình chỉnh sửa trực quan, và để plugin tự động kết nối trang WordPress của bạn với Navi+.
lang: vi
layout: default
