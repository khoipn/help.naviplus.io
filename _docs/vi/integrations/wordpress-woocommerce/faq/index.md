---
description: Các câu hỏi thường gặp về plugin Navi+ WordPress — giá cả, hiệu suất, WooCommerce, multisite, trình xây dựng trang, bộ nhớ đệm, quyền riêng tư và gỡ cài đặt.
lang: vi
layout: default
...
<p>Plugin kết nối với dịch vụ Navi+ để tạo và hiển thị menu. Dữ liệu trao đổi có thể bao gồm (nhưng không giới hạn): tên miền <strong>trang của bạn</strong>, <strong>cấu hình menu của bạn</strong>, và dữ liệu sử dụng tối thiểu cần thiết để hiển thị menu.</p>
