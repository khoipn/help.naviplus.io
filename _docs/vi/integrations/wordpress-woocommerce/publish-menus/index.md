---
description: Xuất bản thực đơn Navi+ trên WordPress bằng cách sử dụng plugin Navi+ — các thực đơn dính sẽ tự động hiển thị trên toàn bộ trang web, trong khi các thực đơn theo phần được đặt thông qua shortcode [naviwp] hoặc khối Gutenberg.
lang: vi
layout: default
