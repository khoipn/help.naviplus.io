---
description: Cài đặt plugin Navi+ trên trang WordPress hoặc WooCommerce của bạn — từ thư mục WordPress.org, tải lên ZIP, FTP, hoặc WP-CLI.
lang: vi
layout: default
permalink: /vi/docs/integrations/wordpress-woocommerce/install-plugin/
title: Cài đặt plugin Navi+
---
# Cài đặt plugin Navi+

> Tên đầy đủ của plugin trên WordPress.org là **Naviplus Menu Builder**. Trong phần còn lại của tài liệu này, nó được gọi là **Navi+** (hoặc chỉ **Navi+**).
