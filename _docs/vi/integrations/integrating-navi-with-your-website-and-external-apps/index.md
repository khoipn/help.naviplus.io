...
Xem ví dụ về tích hợp chat Tidi. Đây là một thiết lập tương đối nâng cao, vì vậy vui lòng liên hệ với hỗ trợ của Navi+ để được trợ giúp.
...
* `open:clickTo` để mô phỏng nhấp vào một Bộ chọn CSS HTML. Điều này cực kỳ hữu ích để cho phép menu Navi+ kích hoạt các menu hamburger mặc định, công cụ tìm kiếm, bảng giỏ hàng, dropdown ngôn ngữ... hoặc kích hoạt các công cụ chat từ các ứng dụng khác.
