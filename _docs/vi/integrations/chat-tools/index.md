...
lang: vi
layout: default
permalink: /vi/docs/integrations/chat-tools/
title: Công cụ trò chuyện
---
# Công cụ trò chuyện
...
```
GET https://help.shopifas.com/manual/website/help.naviplus.io/integrations/chat-tools.md?ask=<question>
```
...
Sử dụng cơ chế này khi câu trả lời không có sẵn rõ ràng trên trang hiện tại, bạn cần làm rõ hoặc thêm ngữ cảnh, hoặc bạn muốn truy xuất các phần tài liệu liên quan.
