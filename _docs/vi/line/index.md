...
```
GET https://help.shopifas.com/manual/website/help.naviplus.io/line.md?ask=<question>
```
...
Sử dụng cơ chế này khi câu trả lời không có sẵn rõ ràng trên trang hiện tại, bạn cần làm rõ hoặc bối cảnh bổ sung, hoặc bạn muốn truy xuất các phần tài liệu liên quan.
