...
lang: vi
layout: default
permalink: /vi/docs/usage/slide-menu-hamburger-menu/publish-on-wordpress-woocommerce-wix-others/
title: Xuất bản trên Squarespace / Khác
---
# Xuất bản trên Squarespace / Khác

> **Trên WordPress?** Sử dụng [plugin Naviplus Menu Builder]({{ site.baseurl }}/docs/usage/slide-menu-hamburger-menu/publish-on-wordpress/) thay vì nhúng thủ công bên dưới — không cần chỉnh sửa giao diện, plugin mở Slide Menu từ bất kỳ bộ chọn CSS nào bạn chọn trong trình chỉnh sửa.
...
> **Trên Wix?** Xem hướng dẫn chuyên dụng [Publish on Wix]({{ site.baseurl }}/vi/docs/usage/slide-menu-hamburger-menu/publishing-on-wix/) — cài đặt ứng dụng Navi+ từ Wix App Market và nó sẽ nhúng tự động, không cần code. Nhúng thủ công dưới đây chỉ dành cho Squarespace, Webflow, và các trang web tùy chỉnh.
...
<details><summary>Làm thế nào tôi có thể biết mã này đã được nhúng thành công trên trang web của mình chưa?</summary>
<p>Có hai cách:</p>
