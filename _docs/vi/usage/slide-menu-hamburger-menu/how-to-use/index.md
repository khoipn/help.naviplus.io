---
description: '**Slide Menu**—còn được gọi là Hamburger Menu, Sidebar Menu, hoặc Drawer Menu—thường được sử dụng trên các trang web Shopify bằng cách điều chỉnh menu trên máy tính để sử dụng trên di động. Thông thường...'
lang: vi
layout: default
...
**Slide Menu**—còn được gọi là Hamburger Menu, Sidebar Menu, hoặc Drawer Menu—thường được sử dụng trên các trang web Shopify bằng cách điều chỉnh menu trên máy tính để sử dụng trên di động. Thông thường, menu mặc định này rất đơn giản, không có hình ảnh hoặc bố cục nâng cao. Navi+ cung cấp một sự thay thế hoàn chỉnh cho menu mặc định cơ bản đó.
...
* Hoạt động liền mạch trên cả di động và máy tính để có trải nghiệm nhất quán
...
<p>Không vấn đề gì cả. Bạn có thể xóa nó và tạo một cái mới bất cứ lúc nào. Nếu bạn đang thử nghiệm một menu và muốn thử một mẫu khác, bạn có thể <strong>lưu</strong> cái hiện tại như một tệp sao lưu và mở lại sau. Bạn thậm chí có thể <strong>sao chép và dán</strong> các phần giữa các menu (bằng cách mở hai tab trình duyệt) để giữ lại công việc trước đó của bạn. Hãy thoải mái thử nghiệm!</p>
</details>
