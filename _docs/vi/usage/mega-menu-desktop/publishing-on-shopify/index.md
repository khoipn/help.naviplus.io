...
Sau 4 bước này, Navi+ đã được cài đặt trên trang web của bạn và sẵn sàng hiển thị. Tuy nhiên, quy trình vẫn chưa hoàn tất. Quay lại tab ứng dụng Navi+ để thực sự bật **Xuất bản Menu**.
...
<p>Nếu bạn cần thông tin bổ sung không có sẵn trực tiếp trên trang này, bạn có thể truy vấn tài liệu một cách động bằng cách đặt câu hỏi.</p>
...
<p><strong>Tại sao bạn cần làm điều này? Navi+ không nhanh rồi sao?</strong></p>
