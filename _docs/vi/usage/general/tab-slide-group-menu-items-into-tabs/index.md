...
Thay vì hiển thị tất cả các mục menu cùng một lúc, **Tab Slide** cho phép bạn tổ chức menu của mình thành các nhóm và đặt mỗi nhóm dưới một tab riêng biệt. Khách truy cập chỉ cần chạm vào một tab để chuyển đổi giữa các nhóm — giúp các menu dài trở nên gọn gàng, ngắn gọn và dễ dàng điều hướng.
...
**Mẹo:** Để bố cục là "Tự động" hoạt động tốt cho hầu hết các menu — tab sẽ tự điều chỉnh để trông đẹp nhất.
...
**Dấu hiệu Tab có xuất hiện như một mục menu không?** Không. Các dấu hiệu Tab không hiển thị với khách truy cập — chúng chỉ tạo ra nút tab. Các mục menu thực tế của bạn là những gì xuất hiện bên trong mỗi tab.
...
**Tab nào được hiển thị đầu tiên?** Tab đầu tiên luôn được chọn mặc định khi menu mở.
