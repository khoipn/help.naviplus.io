---
description: '**CSS Selector** là một khái niệm rất thú vị trong CSS — nó xác định phần nào của trang web của bạn có thể được **thay thế** hoặc **có một menu Navi+ được chèn vào** (hoặc *trước* hoặc *sau* nó).'
lang: vi
layout: default
...
**CSS Selector** là một khái niệm rất thú vị trong CSS — nó xác định phần nào của trang web của bạn có thể được **thay thế** hoặc **có một menu Navi+ được chèn vào** (hoặc *trước* hoặc *sau* nó).
