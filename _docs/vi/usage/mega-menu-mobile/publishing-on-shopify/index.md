...
Phương pháp này chèn menu bằng cách thêm một Block/Section trong chủ đề Shopify của bạn. Đây là một cách tiếp cận truyền thống, vì vậy tôi sẽ không mô tả chi tiết. Với phương pháp này, bạn thậm chí không cần phải **“Bật Navi+ trong App Embeds”** như yêu cầu trong Bước 1 của Phương pháp 1.
