...
lang: vi
layout: default
permalink: /vi/docs/usage/mega-menu-mobile/publish-on-wordpress-woocommerce-wix-others/
title: Xuất bản trên Squarespace / Khác
---
# Xuất bản trên Squarespace / Khác

> **Trên WordPress?** Sử dụng [plugin Naviplus Menu Builder]({{ site.baseurl }}/docs/usage/mega-menu-mobile/publish-on-wordpress/) thay vì nhúng thủ công bên dưới — không cần chỉnh sửa giao diện, đặt Mega Menu qua shortcode hoặc khối Gutenberg.
...
> **Trên Wix?** Xem hướng dẫn chuyên dụng [Publish on Wix]({{ site.baseurl }}/vi/docs/usage/mega-menu-mobile/publishing-on-wix/) — cài đặt ứng dụng Navi+ từ Wix App Market và nó sẽ nhúng tự động, không cần code. Nhúng thủ công dưới đây chỉ dành cho Squarespace, Webflow, và các trang web tùy chỉnh.
...
<p>Mã dưới đây cực kỳ nhẹ và có thể được chèn vào trang web của bạn mà không ảnh hưởng đến tốc độ (chỉ mất khoảng 100-200ms cho lần tải đầu tiên và 0ms cho các lần tải tiếp theo), trải nghiệm khách hàng, hoặc điểm SEO</p>
</details>
...
### 2. Chèn Menu Navi+ tại Bất kỳ Điểm Nào trên Trang Web của Bạn
