...
Trong hướng dẫn này, chúng tôi sẽ tập trung vào 1 cách: chèn menu này trước phần chính. Bạn cũng có thể sử dụng phương pháp này một cách sáng tạo bằng cách tìm và áp dụng các CSS selector khác để kích hoạt menu.
