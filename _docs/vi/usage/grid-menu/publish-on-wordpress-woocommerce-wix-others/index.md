...
lang: vi
layout: default
permalink: /vi/docs/usage/grid-menu/publish-on-wordpress-woocommerce-wix-others/
...
> **Trên Wix?** Xem hướng dẫn chuyên dụng [Publish on Wix]({{ site.baseurl }}/vi/docs/usage/grid-menu/publishing-on-wix/) — cài đặt ứng dụng Navi+ từ Wix App Market và nó sẽ nhúng tự động, không cần code. Nhúng thủ công dưới đây chỉ dành cho Squarespace, Webflow, và các trang web tùy chỉnh.
