---
description: Veröffentlichen Sie Navi+ Menüs auf WordPress mit dem Navi+ Plugin – Sticky Menüs werden automatisch siteweit gerendert, während Abschnittsmenüs über den [naviwp] Shortcode oder Gutenberg Block platziert werden.
lang: de
layout: default
