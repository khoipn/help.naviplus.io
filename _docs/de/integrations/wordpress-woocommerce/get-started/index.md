---
description: Nachdem Sie das Navi+-Plugin aktiviert haben, öffnen Sie Design → Naviplus Menu Builder, erstellen Sie Ihr erstes Menü im visuellen Editor und lassen Sie das Plugin Ihre WordPress-Website automatisch mit Navi+ verbinden.
lang: de
layout: default
