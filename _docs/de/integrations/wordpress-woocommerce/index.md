---
description: Navi+ ist das offizielle WordPress-Plugin für Navi+. Installieren Sie es, erstellen Sie Menüs in WordPress und veröffentlichen Sie sie siteweit oder über den [naviwp] Shortcode — keine Codeänderungen, keine Header-Injektoren.
lang: de
layout: default
permalink: /de/docs/integrations/wordpress-woocommerce/
title: WordPress / WooCommerce — Navi+
---
# WordPress / WooCommerce — Navi+

If your site runs on **WordPress** or **WooCommerce**, the recommended way to publish Navi+ menus is the official **Navi+** plugin on WordPress.org. The full WordPress.org listing name is **Naviplus Menu Builder**.
...
Three install methods are detailed on the dedicated install page: **[Install the Navi+ plugin]({{ site.baseurl }}/docs/integrations/wordpress-woocommerce/install-plugin/)** — admin search (recommended), ZIP upload, or FTP / file manager.
...
3. Design the layout in the **Navi+ visual editor**, opened from the WordPress dashboard.
...
The plugin connects to the Navi+ service to create and **render** your menus. Data exchanged may include (without limitation): your **site domain**, your **menu configuration**, and minimal usage data needed for rendering.
...
| Privacy policy | <https://naviplus.io/privacy> |
| Plugin FAQ (this site) | [Navi+ FAQ]({{ site.baseurl }}/docs/integrations/wordpress-woocommerce/faq/) |
