...
lang: de
layout: default
permalink: /de/docs/integrations/chat-tools/tidi-chat/
title: Tidi chat
---
# Tidi chat
...
### 1. Öffnen Sie den Tidi-Chat und verwenden Sie die Navi+-Menüoption, um auf diese Funktion zuzugreifen
...
### 2. Bewegen Sie das Tidi-Chat-Symbol nach oben, um zu verhindern, dass es mit dem Menü überlappt
...
Setzen Sie einen Offset von 50px, um den Tidi-Chat nach oben oder unten zu verschieben, je nach Bedarf
