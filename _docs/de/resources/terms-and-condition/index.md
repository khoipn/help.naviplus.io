...
lang: de
layout: default
permalink: /de/docs/resources/terms-and-condition/
...
### 2. Zahlung und Sicherheit

Alle Zahlungen für Navi+ Abonnements werden sicher über vertrauenswürdige Drittanbieter-Plattformen wie **Shopify Payments** oder **Lemon Squeezy** verarbeitet, abhängig davon, wo Sie die Anwendung installieren.

Diese Zahlungsplattformen stellen sicher, dass jede Transaktion **sicher, transparent und geschützt** gemäß internationalen Sicherheitsstandards ist.

Navi+ speichert **keine Zahlungsinformationen direkt** und verarbeitet keine Rückerstattungen selbst.\ Durch die Zahlung stimmen Sie zu, die jeweiligen **Bedingungen und Rückerstattungsrichtlinien** des Zahlungsanbieters einzuhalten.

***

### 3. Drittanbieter-Anwendungen

Navi+ kann Drittanbieter-Software, Erweiterungen oder Dienstleistungen enthalten oder integrieren.\ Alle Drittanbieter-Anwendungen, die innerhalb von Navi+ verwendet werden, halten sich an die **MIT-Lizenzprinzipien** und sind verpflichtet, alle **Urheberrechts- und geistigen Eigentumsrechte** zu respektieren.

Während wir die Werkzeuge und Bibliotheken, die wir verwenden, sorgfältig auswählen, ist **Navi+ nicht verantwortlich** für Probleme, Schäden oder Datenverluste, die durch Drittanbieter-Anwendungen verursacht werden.\ Durch die Nutzung dieser Werkzeuge erkennen Sie an, dass alle damit verbundenen Risiken in Ihrer Verantwortung liegen.

***

### 4. Konto und Registrierung

Um bestimmte Funktionen nutzen zu können, müssen Sie möglicherweise ein Konto erstellen.\ Sie stimmen zu:

* **Genau, vollständig und aktuell** Informationen bereitzustellen.
* Ihr **Passwort und Ihre Anmeldedaten sicher** zu halten.
* Vollständig verantwortlich für alle Aktivitäten unter Ihrem Konto zu sein.
* Navi+ sofort über unbefugten Zugriff oder Sicherheitsverletzungen zu informieren.

Navi+ behält sich das Recht vor, jedes Konto zu sperren oder zu kündigen, das **kompromittiert, inaktiv oder gegen** diese Bedingungen oder geltende Gesetze verstößt.
...
* Jegliche **indirekten, zufälligen oder Folgeschäden**,
...
Nach der Kündigung kann Navi+ bestimmte Daten aus technischen oder rechtlichen Gründen für eine begrenzte Zeit aufbewahren, bevor sie dauerhaft gelöscht werden.
...
Diese Bedingungen unterliegen den Gesetzen von **Singapur** und sind nach diesen auszulegen, ohne Rücksicht auf die Grundsätze des internationalen Privatrechts.\ Alle Streitigkeiten, die sich aus oder im Zusammenhang mit diesen Bedingungen ergeben, werden durch **bindende Schiedsverfahren** in Singapur oder an einem anderen einvernehmlich vereinbarten Ort gelöst.
