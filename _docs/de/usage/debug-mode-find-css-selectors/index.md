...
**Wichtige Tipps:** In den meisten Fällen werden Sie nicht sofort den perfekten CSS-Selektor finden. Aufgrund von Erfahrungen ist es oft einfacher:
...
Dann klicken Sie mit der rechten Maustaste irgendwo auf die Seite und wählen Sie:
