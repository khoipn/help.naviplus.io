...
lang: de
layout: default
permalink: /de/docs/usage/shopify/optimize-loading-speed-slide-and-mega-menus/
title: Ladegeschwindigkeit optimieren (Slide & Mega Menüs)
---
# Ladegeschwindigkeit optimieren (Slide & Mega Menüs)

#### Warum müssen Sie das tun? Ist Navi+ nicht schon schnell?
...
#### Slide Menu: Fügen Sie einen Ladeeffekt hinzu und sperren Sie den Trigger-Selector

Sehr einfach: Geben Sie einfach den CSS-Selector ein, den Sie für das Slide Menu im Einbettungsbereich der Navi+-App verwenden (siehe Bild unten).
...
#### Mega Menu (Ersatzmodus): Fügen Sie einen Ladeeffekt hinzu und sperren Sie den Trigger-Selector
