...
lang: de
layout: default
permalink: /de/docs/usage/mega-menu-mobile/publish-on-wordpress-woocommerce-wix-others/
title: Veröffentlichen auf Squarespace / Andere
---
# Veröffentlichen auf Squarespace / Andere

> **Auf WordPress?** Verwenden Sie das dedizierte [Naviplus Menu Builder plugin]({{ site.baseurl }}/docs/usage/mega-menu-mobile/publish-on-wordpress/) anstelle des manuellen Einbettens unten — keine Theme-Änderungen, platzieren Sie das Mega Menu über Shortcode oder Gutenberg-Block.
...
> **Auf Wix?** Siehe den dedizierten [Auf Wix veröffentlichen](/de/docs/usage/mega-menu-mobile/publishing-on-wix/)-Leitfaden — installiere die Navi+ App aus dem Wix App Market und sie bettet sich automatisch ein, kein Code. Die manuelle Einbettung unten ist nur für Squarespace, Webflow und benutzerdefinierte Websites.
...
<details><summary>Wie kann ich feststellen, ob dieser Code erfolgreich auf meiner Website eingebettet wurde?</summary>
