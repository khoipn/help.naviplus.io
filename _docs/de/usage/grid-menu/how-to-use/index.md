---
description: '**Grid Menu** ist ein beliebter Menütet, der in vielen Apps und E-Commerce-Websites verwendet wird. Es zeigt typischerweise Kataloge oder Hauptmerkmale an und wird oft auf der Startseite angezeigt.'
lang: de
layout: default
permalink: /de/docs/usage/grid-menu/how-to-use/
title: Wie benutzt man?
---
# Wie benutzt man?

**Grid Menu** ist ein beliebter Menütet, der in vielen Apps und E-Commerce-Websites verwendet wird. Es zeigt typischerweise Kataloge oder Hauptmerkmale an und wird oft auf der Startseite angezeigt.

Mobile Grid-Menüs nehmen Platz auf dem Bildschirm ein, da sie auf dem Bildschirm schweben. Als Abschnittsmenü scrollen sie mit der Seite.
...
Dies ist ein 1-stufiger Menübaum. Grid-Menüs unterstützen keine mehreren Menüebenen, um die Einfachheit zu wahren..
