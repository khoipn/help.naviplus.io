...
> **Auf Wix?** Siehe den dedizierten [Auf Wix veröffentlichen](/de/docs/usage/grid-menu/publishing-on-wix/)-Leitfaden — installiere die Navi+ App aus dem Wix App Market und sie bettet sich automatisch ein, kein Code. Die manuelle Einbettung unten ist nur für Squarespace, Webflow und benutzerdefinierte Websites.
