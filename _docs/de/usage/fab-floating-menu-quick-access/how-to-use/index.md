---
description: Ein **FAB (Floating Action Button)** ist ein einfaches Menü, das immer am unteren Rand des Bildschirms schwebt und typischerweise für Unterstützung verwendet wird. FABs bieten oft Chat-Tools...
lang: de
layout: default
permalink: /de/docs/usage/fab-floating-menu-quick-access/how-to-use/
title: Wie benutzt man?
---
# Wie benutzt man?

Ein **FAB (Floating Action Button)** ist ein einfaches Menü, das immer am unteren Rand des Bildschirms schwebt und typischerweise für Unterstützung verwendet wird. FABs bieten oft Chat-Tools wie WhatsApp, Messaging, E-Mail sowie Links zu Unterstützungsressourcen und sozialen Medien, um Ihre Website zu fördern.
...
Hier ist ein Beispiel für einen Menübaum:

```
Support  
- Banner  
- Chat mit uns (Als Gruppe angezeigt)  
- Whats App
- Telegram
- Facebook Messager
- ...  
...
Dies ist ein 2-stufiger Menübaum. Sie können je nach Ihrer Kreativität bis zu 3 Ebenen auf einem FAB erstellen; jedoch sind 2 Ebenen normalerweise die optimale Wahl für die Einfachheit.
...
**Option 1&#x20;**<mark style="background-color:$warning;">**(Nicht empfohlen, wenn Sie neu bei Navi+ sind)**</mark>**:** Klicken Sie auf „Menü hinzufügen“, um ein leeres Menüelement am Ende des Menübaums einzufügen. Diese Methode erfordert ein gutes Verständnis der Einstellungen für Menüelemente, die wir weiter unten behandeln werden. Es kann anfangs überwältigend erscheinen, also können Sie dies später erkunden.
...
Nach diesen 4 Schritten wurde Navi+ auf Ihrer Website installiert und ist bereit zur Anzeige. Der Prozess ist jedoch noch nicht abgeschlossen. Gehen Sie zurück zum Tab der Navi+ App, um tatsächlich **Menü veröffentlichen** zu aktivieren.
