---
description: Veröffentlichen Sie einen Navi+ FAB (Floating Action Button) auf WordPress mit dem Navi+ Plugin. Der FAB ist ein Sticky-Menü — einmal im Editor veröffentlicht, erscheint er automatisch auf der gesamten Website.
lang: de
layout: default
...
Ein **FAB (Floating Action Button)** ist ein **Sticky**-Menü — es schwebt über der Seite (typischerweise in einer Ecke) und bleibt an Ort und Stelle, während die Besucher scrollen. Auf WordPress rendert das Navi+ Plugin es automatisch auf der gesamten Website; Sie fügen keinen Code oder Shortcode ein.
...
1. **Installieren Sie das Plugin** — siehe [Installieren Sie das Navi+ Plugin]({{ site.baseurl }}/docs/integrations/wordpress-woocommerce/install-plugin/).
