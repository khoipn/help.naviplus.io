...
lang: de
layout: default
permalink: /de/docs/usage/fab-floating-menu-quick-access/publishing-on-shopify/
...
* Wenn Ihre Website neu ist und noch keine Benutzer hat, können Sie das Menü ohne Bedenken veröffentlichen – Sie können es jederzeit problemlos ein- oder ausschalten, ohne die Besucher zu beeinträchtigen.
...
Nach diesen 4 Schritten wurde Navi+ auf Ihrer Website installiert und ist bereit zur Anzeige. Der Prozess ist jedoch noch nicht abgeschlossen. Gehen Sie zurück zum Tab der Navi+-App, um **Menü veröffentlichen** tatsächlich zu aktivieren.
