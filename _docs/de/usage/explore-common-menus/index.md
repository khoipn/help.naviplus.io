---
description: Navi+ bietet eine umfassende Menülösung für Ihre Website – weit über traditionelle Dropdowns hinaus.
lang: de
layout: default
...
Navi+ bietet eine umfassende Menülösung für Ihre Website – weit über traditionelle Dropdowns hinaus.

Je nach Gerätetyp und gewünschter Benutzererfahrung können Sie aus mehreren flexiblen und optimierten Menü-Stilen wählen:
...
#### 2. Mega Menu (Desktop) - Extrem beliebt

Entwickelt für Desktop-Websites, ist das Mega Menu perfekt, wenn Sie:

* Mehrere Produktkategorien oder Inhaltsabschnitte gleichzeitig anzeigen möchten
* Links in Spalten, Gruppen oder visuellen Layouts organisieren möchten
* Eine professionelle und intuitive Browsing-Erfahrung bieten möchten

Plattform: **Nur Desktop**
...
#### 3. Mobile Mega Menu - Nicht üblich

Eine Version des Mega Menüs, die für mobile Bildschirme optimiert ist – kompakt, daumenfreundlich und einfach zu navigieren.
...
* Schnelle Kontaktbuttons (Chat, Hotline, Zalo, Messenger)
