---
description: Navi+ bietet ein Testpaket mit nahezu vollständigen Funktionen für alle Websites an. Nach einer bestimmten Zeit, wenn die Besuche auf Ihrer Website (wo Besuche gezählt werden, wenn Navi+ auf der Website angezeigt wird) jedoch...
lang: de
layout: default
...
3. Wir werden keine Funktionen von Navi+, die derzeit auf Ihrer Website angezeigt werden, deaktivieren oder entfernen. Wir verstehen voll und ganz, dass diese Funktionen entscheidend für die Benutzerinteraktion auf Ihrer Website sind, daher werden wir dies strikt vermeiden.

#### Frage 2: Was passiert, wenn Sie von Business oder Elite zurück zu Starter downgraden, es jedoch so aussieht, als ob alle Funktionen erhalten bleiben?

Wir verstehen, dass Funktionen und Benutzererfahrung entscheidend für Ihre Kunden sind, daher stellen wir sicher, dass keine Funktionen in Ihrem Menü verborgen oder entfernt werden. Wir haben jedoch ein System, das täglich einen Scan durchführt. Sobald es erkennt, dass sich Ihre Website in dieser Situation befindet, werden wir Ihnen eine E-Mail-Benachrichtigung senden, um Sie zu ermutigen, auf einen höheren Plan upzugraden. Diese E-Mail-Benachrichtigungen werden über einen Zeitraum verteilt, um zu vermeiden, dass Sie mit zu vielen Nachrichten überfordert werden. Wenn Sie sich entscheiden, nicht auf die Business- oder Elite-Pläne zurückzukehren, wird Navi+ beginnen, Anzeigen anzuzeigen, wie in Frage 1 erklärt.

#### Frage 3: Was passiert, wenn ich das Limit des Business-Plans überschreite (z. B. mehr als 500.000 Navi+-Ansichten/Monat)?

Wie bei den vorherigen Fragen wird Navi+ keine Menüfunktionen verbergen oder entfernen. Sobald das Limit jedoch überschritten ist und nachdem E-Mail-Benachrichtigungen an Sie gesendet wurden, um ein Upgrade auf den Elite-Plan in Betracht zu ziehen, können Anzeigen in Ihrem Menü angezeigt werden, bis der Beginn eines neuen monatlichen Zyklus erfolgt.
