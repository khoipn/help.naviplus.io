---
description: Algunos mega menús pueden ser muy altos. En ese caso, expandir un menú de nivel 3 puede no dejar suficiente espacio. Cuando esto sucede, debes fijar el menú de nivel 3 en la parte superior en su lugar.
lang: es
layout: default
permalink: /es/docs/frequently-asked-questions/customize-user-interface-ui/align-level-3-submenu-in-mega-menu/
title: ¿Alinear el submenú de nivel 3 en el mega menú?
---
# ¿Alinear el submenú de nivel 3 en el mega menú?

Algunos mega menús pueden ser muy altos. En ese caso, expandir un menú de nivel 3 puede no dejar suficiente espacio. Cuando esto sucede, debes fijar el menú de nivel 3 en la parte superior en su lugar.
...
Pégalo en el cuadro de Hoja de Estilos Interna / CSS:
...
```
GET https://help.shopifas.com/manual/website/help.naviplus.io/frequently-asked-questions/customize-user-interface-ui/align-level-3-submenu-in-mega-menu.md?ask=<pregunta>
```
