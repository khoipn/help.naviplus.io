...
* Reemplaza completamente el menú simple predeterminado de Shopify
...
* Funciona sin problemas tanto en móviles como en escritorio para una experiencia consistente
...
Aquí hay un ejemplo de un árbol de menú de Slide menu:
