...
lang: es
layout: default
permalink: /es/docs/usage/slide-menu-hamburger-menu/publish-on-wordpress-woocommerce-wix-others/
title: Publicar en Squarespace / Otros
---
# Publicar en Squarespace / Otros

> **¿En WordPress?** Use el plugin dedicado [Naviplus Menu Builder]({{ site.baseurl }}/docs/usage/slide-menu-hamburger-menu/publish-on-wordpress/) en lugar de la inserción manual a continuación — sin ediciones de tema, el plugin abre el Slide Menu desde cualquier selector CSS que elija en el editor.

> **¿En Shopify?** Instale la [aplicación dedicada de Shopify](https://apps.shopify.com/pronavi-navigation-design) — está optimizada para la plataforma con opciones de publicación integradas.

> **¿En Wix?** Consulte la guía dedicada [Publicar en Wix](/es/docs/usage/slide-menu-hamburger-menu/publishing-on-wix/) — instale la aplicación Navi+ desde el Mercado de aplicaciones de Wix y se integra automáticamente, sin código. La integración manual a continuación es solo para Squarespace, Webflow y sitios personalizados.
