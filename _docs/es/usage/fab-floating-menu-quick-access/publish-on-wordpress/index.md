---
description: 'Publica un Navi+ FAB (Floating Action Button) en WordPress con el plugin Navi+. El FAB es un menú fijo: una vez publicado en el editor, aparece automáticamente en todo el sitio.'
lang: es
layout: default
...
A **FAB (Floating Action Button)** es un **menú fijo** — flota sobre la página (típicamente en una esquina) y se mantiene en su lugar mientras los visitantes desplazan. En WordPress, el plugin Navi+ lo renderiza automáticamente en todo el sitio; no necesitas pegar ningún código o shortcode.
