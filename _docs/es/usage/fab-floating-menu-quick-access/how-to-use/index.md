---
description: Un **FAB (Floating Action Button)** es un menú simple que siempre flota en la parte inferior de la pantalla, típicamente utilizado para soporte. Los FABs a menudo proporcionan herramientas de chat...
lang: es
layout: default
permalink: /es/docs/usage/fab-floating-menu-quick-access/how-to-use/
title: ¿Cómo usar?
---
# ¿Cómo usar?

Un **FAB (Floating Action Button)** es un menú simple que siempre flota en la parte inferior de la pantalla, típicamente utilizado para soporte. Los FABs a menudo proporcionan herramientas de chat como WhatsApp, mensajería, correo electrónico, así como enlaces a recursos de soporte y canales de redes sociales para promover tu sitio web.
...
Soporte  
- Banner  
- Chatea con nosotros (Mostrado como Grupo)  
- Whats App
- Telegram
- Facebook Messager
- ...  
...
### Paso 2: (Shopify) Publicar el menú en tu sitio web.
