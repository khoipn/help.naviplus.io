---
description: Navi+ es muy rápido. Está completamente desplegado en una CDN líder con muy baja latencia (alrededor de 100 ms) y puede atender a millones de clientes sin desacelerarse.
lang: es
layout: default
permalink: /es/docs/usage/shopify/optimize-loading-speed-slide-and-mega-menus/
title: Optimizar la velocidad de carga (Slide & Mega menus)
---
# Optimizar la velocidad de carga (Slide & Mega menus)
...
#### Mega Menu (Replacement mode): Agregar un efecto de carga y bloquear el selector del disparador
...
* Deja sin sufijo si deseas que se aplique en ambas plataformas.
