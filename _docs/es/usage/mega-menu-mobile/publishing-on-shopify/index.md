...
lang: es
layout: default
permalink: /es/docs/usage/mega-menu-mobile/publishing-on-shopify/
...
<p>En móvil, no hay Mega Menú para reemplazar, por lo que este método generalmente no es factible</p>
</details>
