...
Aquí hay un ejemplo de un árbol de menú de menú grid móvil:
...
Este es un árbol de menú de 1 nivel. Los menús Grid no admiten múltiples niveles de menú para mantener la simplicidad..
