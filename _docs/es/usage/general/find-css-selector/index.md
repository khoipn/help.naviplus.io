---
description: '**Selector CSS** es un concepto muy interesante en CSS — define qué parte de tu sitio web puede ser **reemplazada** o **tener un menú Navi+ insertado** (ya sea *antes* o *después* de él).'
lang: es
layout: default
permalink: /es/docs/usage/general/find-css-selector/
title: Encontrar Selector CSS
---
# Encontrar Selector CSS

**Selector CSS** es un concepto muy interesante en CSS — define qué parte de tu sitio web puede ser **reemplazada** o **tener un menú Navi+ insertado** (ya sea *antes* o *después* de él).

Aquí hay algunos **ejemplos de Selectores CSS** que puedes usar:

```css
#header           /* El área del encabezado */
.navbar           /* La barra de navegación principal */
.footer           /* La sección del pie de página */
.main-content     /* El contenedor del contenido principal */
.product-gallery  /* La sección de imágenes del producto */
div#menu-wrapper  /* Un div específico con ID “menu-wrapper” */
section.hero      /* La sección hero en la parte superior de la página */
```

Sigue las instrucciones a continuación para **encontrar el Selector CSS correcto** en tu sitio web.
...
```
GET https://help.shopifas.com/manual/website/help.naviplus.io/usage/general/find-css-selector.md?ask=<pregunta>
```
