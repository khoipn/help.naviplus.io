---
description: Instala el plugin Navi+ en tu sitio de WordPress o WooCommerce — desde el directorio de WordPress.org, una carga ZIP, FTP o WP-CLI.
lang: es
layout: default
permalink: /es/docs/integrations/wordpress-woocommerce/install-plugin/
title: Instala el plugin Navi+
---
# Instala el plugin Navi+

> El nombre completo del plugin en WordPress.org es **Naviplus Menu Builder**. En el resto de estos documentos se le denomina **Navi+** (o simplemente **Navi+**).
