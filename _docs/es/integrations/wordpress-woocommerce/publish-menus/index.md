---
description: 'Publica menús Navi+ en WordPress utilizando el plugin Navi+: los menús fijos se renderizan automáticamente en todo el sitio, mientras que los menús de sección se colocan a través del shortcode [naviwp] o bloque de Gutenberg.'
lang: es
layout: default
