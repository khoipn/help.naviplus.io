---
description: Después de activar el plugin Navi+, abre Apariencia → Naviplus Menu Builder, crea tu primer menú en el editor visual y deja que el plugin conecte automáticamente tu sitio de WordPress a Navi+.
lang: es
layout: default
