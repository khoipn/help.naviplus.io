...
lang: es
layout: default
permalink: /es/docs/resources/terms-and-condition/
...
Todos los pagos por suscripciones de Navi+ se procesan de manera segura a través de plataformas de terceros de confianza como **Shopify Payments** o **Lemon Squeezy**, dependiendo de dónde instale la aplicación.
...
* Ser completamente responsable de todas las actividades bajo su cuenta.
* Notificar a Navi+ de inmediato sobre cualquier acceso no autorizado o violaciones de seguridad.

Navi+ se reserva el derecho de suspender o terminar cualquier cuenta que parezca estar **comprometida, inactiva o en violación** de estos Términos o leyes aplicables.

***

### 5. Propiedad del Contenido y Licencia

Usted retiene la plena propiedad de todo el **contenido, imágenes, datos y materiales** subidos o creados mientras usa Navi+.
...
* Pérdida de ingresos, datos u oportunidades comerciales, o 
* Problemas técnicos causados por proveedores de terceros, infraestructura o acciones del usuario.

En cualquier caso, la responsabilidad total de Navi+ no **excederá la cantidad pagada por usted** por el Servicio durante los **doce (12) meses anteriores**.

***

### 7. Terminación del Servicio

Podemos suspender o terminar su acceso a Navi+ en cualquier momento, sin previo aviso, si:

1. Usted viola estos Términos o leyes aplicables.
2. Recibimos una solicitud legal de Shopify, Lemon Squeezy o cualquier plataforma asociada.
3. El Servicio requiere mantenimiento, actualización o descontinuación permanente.

También puede terminar su cuenta en cualquier momento desinstalando la aplicación o contactando al soporte.

Después de la terminación, Navi+ puede retener ciertos datos por un tiempo limitado por razones técnicas o legales antes de la eliminación permanente.
