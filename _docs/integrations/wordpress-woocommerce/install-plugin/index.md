---
description: Install the Navi+ Menu Builder plugin on your WordPress or WooCommerce site — from the WordPress.org directory, a ZIP upload, FTP, or WP-CLI.
layout: default
permalink: /docs/integrations/wordpress-woocommerce/install-plugin/
title: Install the Navi+ Menu Builder plugin
---
# Install the Navi+ Menu Builder plugin

> The plugin's full name on WordPress.org is **Naviplus Menu Builder**. In the rest of these docs it's referred to as **Navi+ Menu Builder** (or just **Navi+**).
