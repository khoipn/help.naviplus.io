---
description: Publish Navi+ menus on WordPress using the Navi+ plugin — sticky menus render site-wide automatically, while section menus are placed via the [naviwp] shortcode or Gutenberg block.
layout: default
