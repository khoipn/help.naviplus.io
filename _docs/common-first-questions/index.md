---
description: Navi+ is a menu builder that works on any website — Shopify, WordPress, WooCommerce, Wix, Webflow, and more. It lets you add Tab Bars, Mega Menus, Slide Menu...
layout: default
...
Any website. For Shopify, use the dedicated app. For everything else, sign up at [dash.naviplus.app](https://dash.naviplus.app/ "dash.naviplus.app") and embed with a code snippet.

#### How do I install Navi+?

* **Shopify:** Install from the [Shopify App Store](https://apps.shopify.com/pronavi-navigation-design "Shopify App Store")
* **Other platforms:** Sign up at [dash.naviplus.app](https://dash.naviplus.app/ "dash.naviplus.app"), declare your domain, then embed the snippet

#### Can I try Navi+ before setting it up?

Yes. Visit [showcase.naviplus.io](https://showcase.naviplus.io/ "showcase.naviplus.io") to see all menu types on a real store — mobile, tablet, and desktop.
...
Start free with the Starter plan. Business and Elite plans unlock advanced features. See full pricing at [naviplus.io/pricing](https://naviplus.io/pricing/ "naviplus.io/pricing").
...
Rarely. Navi+ doesn't modify your theme or require any permissions. If menus overlap with other sticky elements, adjust the z-index — [see guide](https://help.naviplus.io/docs/usage/general/z-index/ "see guide").
...
Reach out via [WhatsApp](https://wa.me/84981911011 "WhatsApp") or email <khoipng@naviplus.io>.
