---
description: Você não precisa saber sobre desenvolvimento ou design para usar o Navi+. É um software pré-construído que pode ser facilmente incorporado ao seu site. Toda a configuração —...
lang: pt-br
layout: default
permalink: /pt-br/docs/how-to-install-navi/
title: Como instalar o Navi+
---
# Como instalar o Navi+
...
**Se você estiver usando outras plataformas** como WordPress, WooCommerce, Wix, Webflow, Squarespace, ou um site auto-hospedado:

1. Vá para <https://naviplus.io>
