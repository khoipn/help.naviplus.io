---
description: Após ativar o plugin Navi+, abra Aparência → Naviplus Menu Builder, crie seu primeiro menu no editor visual e deixe o plugin conectar automaticamente seu site WordPress ao Navi+.
lang: pt-br
layout: default
