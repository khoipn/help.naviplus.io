---
description: Navi+ é o plugin oficial do WordPress para Navi+. Instale-o, crie menus dentro do WordPress e publique-os em todo o site ou via o shortcode [naviwp] — sem edições de código, sem injetores de cabeçalho.
lang: pt-br
layout: default
...
Se o seu site roda em **WordPress** ou **WooCommerce**, a maneira recomendada de publicar menus Navi+ é o plugin oficial **Navi+** no WordPress.org. O nome completo da listagem no WordPress.org é **Naviplus Menu Builder**.
...
Três métodos de instalação são detalhados na página de instalação dedicada: **[Instale o plugin Navi+]({{ site.baseurl }}/docs/integrations/wordpress-woocommerce/install-plugin/)** — pesquisa de administrador (recomendado), upload de ZIP ou FTP / gerenciador de arquivos.
...
3. Projete o layout no **editor visual do Navi+**, aberto a partir do painel do WordPress.
...
O plugin se conecta ao serviço Navi+ para criar e **renderizar** seus menus. Os dados trocados podem incluir (sem limitação): seu **domínio do site**, sua **configuração de menu**, e dados mínimos de uso necessários para renderização.
...
| Política de privacidade | <https://naviplus.io/privacy> |
| FAQ do plugin (este site) | [Navi+ FAQ]({{ site.baseurl }}/docs/integrations/wordpress-woocommerce/faq/) |
