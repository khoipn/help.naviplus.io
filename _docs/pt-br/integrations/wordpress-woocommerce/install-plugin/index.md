---
description: Instale o plugin Navi+ no seu site WordPress ou WooCommerce — a partir do diretório WordPress.org, um upload ZIP, FTP ou WP-CLI.
lang: pt-br
layout: default
permalink: /pt-br/docs/integrations/wordpress-woocommerce/install-plugin/
title: Instale o plugin Navi+
---
# Instale o plugin Navi+

> O nome completo do plugin no WordPress.org é **Naviplus Menu Builder**. No restante deste documento, ele é referido como **Navi+** (ou apenas **Navi+**).
