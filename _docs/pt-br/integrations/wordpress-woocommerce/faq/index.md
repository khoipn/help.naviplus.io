---
description: Perguntas frequentes sobre o plugin Navi+ para WordPress — preços, desempenho, WooCommerce, multisite, construtores de páginas, cache, privacidade e desinstalação.
lang: pt-br
layout: default
...
<p>O plugin se conecta ao serviço Navi+ para criar e renderizar menus. Os dados trocados podem incluir (mas não estão limitados a): seu <strong>domínio do site</strong>, sua <strong>configuração de menu</strong> e dados mínimos de uso necessários para renderizar menus.</p>
