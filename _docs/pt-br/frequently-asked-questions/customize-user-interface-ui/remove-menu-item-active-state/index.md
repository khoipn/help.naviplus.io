...
Método 1: Se você quiser aplicar isso apenas a este menu, o código CSS é o seguinte (cole-o na caixa de Folhas de Estilo Internas / CSS):
...
Método 2: Se você quiser remover todos os efeitos ativos em todos os menus do Navi+, use o seguinte código (cole-o na caixa de Folhas de Estilo Globais / CSS):
