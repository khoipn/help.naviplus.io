...
* Você pode separar as configurações CSS para menus do Navi+ do seu tema. Isso significa que atualizar ou mudar seu tema não afetará seus menus do Navi+.
...
**Nota importante:** A **caixa de texto de Estilo Interno / CSS** adiciona automaticamente um prefixo (por exemplo, `#SF-123456789`) antes de cada regra CSS. Isso garante que seu CSS se aplique apenas ao menu específico que está sendo personalizado e previne conflitos de estilo.
