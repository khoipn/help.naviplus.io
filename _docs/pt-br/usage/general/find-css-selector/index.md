---
description: '**Seletor CSS** é um conceito muito interessante em CSS — ele define qual parte do seu site pode ser **substituída** ou **ter um menu Navi+ inserido** (seja *antes* ou *depois* dela).'
lang: pt-br
layout: default
...
**Seletor CSS** é um conceito muito interessante em CSS — ele define qual parte do seu site pode ser **substituída** ou **ter um menu Navi+ inserido** (seja *antes* ou *depois* dela).
