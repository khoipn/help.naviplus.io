...
Por exemplo, imagine que você tem uma Tabbar do Navi+ exibida em seu site com 3 idiomas: English (padrão), Francês e Vietnamita. O código curto para Francês é `fr` e para Vietnamita é `vi`.
...
* Se o padrão é English, ele mostra **Home**.
...
Navi+ suporta uma sintaxe especial que permite que você troque de idioma diretamente dos itens do seu menu.
