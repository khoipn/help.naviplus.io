...
> **No WordPress?** Use o [plugin Naviplus Menu Builder]({{ site.baseurl }}/docs/usage/grid-menu/publish-on-wordpress/) em vez da incorporação manual abaixo — sem edições de tema, coloque a Grade via shortcode ou bloco Gutenberg.
