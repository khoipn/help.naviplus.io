...
> **No WordPress?** Use o [plugin Naviplus Menu Builder]({{ site.baseurl }}/docs/usage/mega-menu-desktop/publish-on-wordpress/) em vez da incorporação manual abaixo — sem edições de tema, coloque o Mega Menu via shortcode ou bloco Gutenberg.
