---
description: Publique um Navi+ FAB (Floating Action Button) no WordPress com o plugin Navi+. O FAB é um menu fixo — uma vez publicado no editor, ele aparece em todo o site automaticamente.
lang: pt-br
layout: default
...
A **FAB (Floating Action Button)** é um **menu fixo** — ele flutua acima da página (tipicamente em um canto) e permanece no lugar enquanto os visitantes rolam. No WordPress, o plugin Navi+ o renderiza em todo o site automaticamente; você não precisa colar nenhum código ou shortcode.
