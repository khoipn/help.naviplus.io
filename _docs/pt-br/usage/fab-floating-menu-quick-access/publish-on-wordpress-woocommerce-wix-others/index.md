...
> **No WordPress?** Use o plugin dedicado [Naviplus Menu Builder]({{ site.baseurl }}/docs/usage/fab-floating-menu-quick-access/publish-on-wordpress/) em vez da incorporação manual abaixo — sem edições de tema, o FAB é renderizado em todo o site automaticamente uma vez publicado no editor.
...
> **No Wix?** Veja o guia dedicado [Publicar no Wix](/pt-br/docs/usage/fab-floating-menu-quick-access/publishing-on-wix/) — instale o aplicativo Navi+ do Wix App Market e ele se incorpora automaticamente, sem código. A incorporação manual abaixo é apenas para Squarespace, Webflow e sites personalizados.
