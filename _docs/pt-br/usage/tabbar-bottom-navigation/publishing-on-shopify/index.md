...
lang: pt-br
layout: default
permalink: /pt-br/docs/usage/tabbar-bottom-navigation/publishing-on-shopify/
...
#### 2.1. Ative o Navi+ em Embeds de App
...
Após esses 4 passos, o Navi+ foi instalado em seu site e está pronto para ser exibido. No entanto, o processo ainda não está completo. Volte para a aba do app Navi+ para realmente ativar **Publicar Menu**.
