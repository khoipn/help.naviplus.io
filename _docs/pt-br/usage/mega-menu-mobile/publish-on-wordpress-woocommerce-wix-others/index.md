...
lang: pt-br
layout: default
permalink: /pt-br/docs/usage/mega-menu-mobile/publish-on-wordpress-woocommerce-wix-others/
title: Publicar em Squarespace / Outros
---
# Publicar em Squarespace / Outros

> **No WordPress?** Use o plugin dedicado [Naviplus Menu Builder]({{ site.baseurl }}/docs/usage/mega-menu-mobile/publish-on-wordpress/) em vez da incorporação manual abaixo — sem edições de tema, coloque o Mega Menu via shortcode ou bloco Gutenberg.
...
> **No Wix?** Veja o guia dedicado [Publicar no Wix](/pt-br/docs/usage/mega-menu-mobile/publishing-on-wix/) — instale o aplicativo Navi+ do Wix App Market e ele se incorpora automaticamente, sem código. A incorporação manual abaixo é apenas para Squarespace, Webflow e sites personalizados.
...
<p>Esta é a configuração mais comum para um Mega Menu mobile.</p>
<p>Seletores CSS comuns para esta opção:</p>
<ul>
<li><code>header</code> — funciona na maioria das plataformas</li>
<li><code>.header-wrapper</code> — algumas plataformas</li>
<li><code>.mobile-header</code> — plataformas com um elemento de cabeçalho mobile dedicado</li>
</ul>
<p>Não está nesta lista? Você pode conversar com um suporte do Navi+ para ajuda instantânea, ou usar <a href="/docs/usage/debug-mode-find-css-selectors/">Modo Debug</a> ou <a href="/docs/usage/general/find-css-selector/">Browser DevTools</a> para encontrá-lo você mesmo.</p>
</details>
...
<p>No mobile, a maioria das plataformas agrupa o menu mobile dentro do cabeçalho ou de um toggle hambúrguer, então pode não haver um elemento autônomo para substituir. Inserir Antes ou Inserir Depois é recomendado em vez disso.</p>
<p>Se a sua plataforma tiver um elemento de menu mobile dedicado que você quer substituir, use <a href="/docs/usage/debug-mode-find-css-selectors/">Modo Debug</a> ou <a href="/docs/usage/general/find-css-selector/">Browser DevTools</a> para encontrar o Seletor CSS dele.</p>
</details>
...
Para menus mobile, usar o sufixo `(M)` garante que o menu apareça apenas em dispositivos móveis e não interfira no layout desktop.
