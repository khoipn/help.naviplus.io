...
> **No Wix?** Veja o guia dedicado [Publicar no Wix](/pt-br/docs/usage/slide-menu-hamburger-menu/publishing-on-wix/) — instale o aplicativo Navi+ do Wix App Market e ele se incorpora automaticamente, sem código. A incorporação manual abaixo é apenas para Squarespace, Webflow e sites personalizados.
