---
description: Publique um Navi+ Slide Menu (hamburger) no WordPress com o plugin Navi+. O plugin carrega o menu em todo o site e o gatilho é configurado dentro do editor Navi+ — sem edições de tema, sem shortcode para a configuração típica.
lang: pt-br
layout: default
...
A **Slide Menu** (também conhecido como menu hamburger) desliza de um lado e é a navegação principal para árvores de menu profundas em dispositivos móveis. No WordPress, o plugin Navi+ o carrega em todo o site e o editor Navi+ cuida do gatilho de abertura — sem edições de tema, sem shortcode para a configuração típica.
