...
lang: pt-br
layout: default
permalink: /pt-br/docs/development/menu-structure-and-css/
...
`SF-…` é o id de incorporação do menu (veja DevTools na página ao vivo).
...
2. *(Opcional)* **`span.cart_count`** — apenas quando o item usa o badge do carrinho com contagem.
3. **Mídia — um dos:**
...
#### Demonstração completa em HTML (classes ilustrativas / URLs)
  ...
  <ul class="navigation">
    ...
    <li class="item level-1 is-parent-top" linkto="/collections/all" data-name="Loja">
      ...
      <div class="inner inner-level1">
        ...
        <!-- <span class="cart_count">3</span>  ← badge do carrinho apenas -->
...
* Seta: `.arrow` (geralmente a primeira dentro de `.inner`).

***

### Classes faltando na loja?

Limpe o cache do tema, republice o menu ou verifique a versão do script. Use DevTools para confirmar os nomes das classes na página ao vivo.
