---
description: Você precisará usar uma biblioteca como TourGuideJS, uma biblioteca JavaScript que pode ser incorporada ao seu site para adicionar guias passo a passo através de um formato de atributo como <div data-tg-tour="<span>Meu primeiro tour</span>"> ... </div>. É completamente gratuito. Siga as instruções abaixo para adicionar walkthroughs pelos menus do Navi+, seja para o menu inteiro ou para itens de menu individuais.
lang: pt-br
layout: default
permalink: /pt-br/docs/development/add-walk-through-to-navi/
title: Adicionar walkthrough ao Navi+
---
